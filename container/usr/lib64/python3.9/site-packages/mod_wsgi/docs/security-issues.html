...
<head>
  ...
  <title>Security Issues &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="_static/pygments.css" type="text/css" />
    ...
    <link rel="prev" title="Project Status" href="project-status.html" /> 
</head>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Security Issues</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/security-issues.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Security Issues<a class="headerlink" href="#security-issues" title="Permalink to this headline">¶</a></h1>
<p>Due to security issues in versions of mod_wsgi up to and including version
3.4, ensure that you are using version 3.5 or later.</p>
<p>Release notes for versions containing security related fixes are:</p>
<ul class="simple">
<li><p><a class="reference internal" href="release-notes/version-3.5.html"><span class="doc">Version 3.5</span></a></p></li>
</ul>
<p>Because many Linux distributions still ship ancient out of date versions,
...
recent version.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="project-status.html" class="btn btn-neutral float-left" title="Project Status" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
