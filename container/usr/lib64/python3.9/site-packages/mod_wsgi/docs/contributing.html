...
<head>
  ...
  <title>Contributing &mdash; mod_wsgi 4.7.1 documentation</title>
...
<ul class="simple">
<li><p>If using mod_wsgi for personal use, then consider donating what you would
pay for one months worth of a single host used to run your own site.</p></li>
<li><p>If using mod_wsgi for a company web site, then consider donating what you
would pay for two months worth of a single host used to run that site.</p></li>
<li><p>If using mod_wsgi as part of a web hosting service which you then charge
other people for using, then consider donating what you would pay for
three months worth of a single host used to run that site.</p></li>
</ul>
...
mental health of Open Source developers is more important than you are.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="source-code.html" class="btn btn-neutral float-right" title="Source Code" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="reporting-bugs.html" class="btn btn-neutral float-left" title="Reporting Bugs" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
