...
<head>
  ...
  <title>Version 2.6 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 2.5" href="version-2.5.html" />
    <link rel="prev" title="Version 2.7" href="version-2.7.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 2.6</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-2.6.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 2.6<a class="headerlink" href="#version-2-6" title="Permalink to this headline">¶</a></h1>
<p>Version 2.6 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-2.6.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-2.6.tar.gz</a></p>
</div></blockquote>
<p>For Windows binaries see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/wiki/InstallationOnWindows">http://code.google.com/p/modwsgi/wiki/InstallationOnWindows</a></p>
</div></blockquote>
<p>Note that this release does not support Python 3.0. Python 3.0 will only be
supported in mod_wsgi 3.0.</p>
<p>Note that the fix for (3) below is believed to have already been backported
to mod_wsgi 2.5 in Debian Stable tree. Thus, if using mod_wsgi 2.5 from
Debian you do not need to be concerned about upgrading to this version.</p>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Fixed build issue on MacOS X where incorrect Python framework found at
...
undone. This would affect Python 2.3 through 2.5. For more details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=28">http://code.google.com/p/modwsgi/issues/detail?id=28</a></p>
</div></blockquote>
<p>2. Fixed build issue on MacOS X where incorrect Python framework found at
...
doesn’t seem to work for the older Python versions.</p>
<p>Because of the unpredictability as to when ‘-F/-framework’ or ‘-L/-l’
...
<p>3. Fixed bug where was decrementing Python object reference count on NULL
...
<p>4. Fixed bug for Python 2.X where when using ‘print’ to output multple
...
lacked a softspace attribute.</p>
</div>
...
<p>1. When trying to determining version of Apache being used at build time,
...
header files and apxs tool needed to build modules. For more details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=147">http://code.google.com/p/modwsgi/issues/detail?id=147</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-2.5.html" class="btn btn-neutral float-right" title="Version 2.5" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.7.html" class="btn btn-neutral float-left" title="Version 2.7" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
