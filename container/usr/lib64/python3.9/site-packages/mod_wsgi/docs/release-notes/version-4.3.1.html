...
<head>
  ...
  <title>Version 4.3.1 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.3.0" href="version-4.3.0.html" />
    <link rel="prev" title="Version 4.3.2" href="version-4.3.2.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.3.1</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.3.1.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 4.3.1<a class="headerlink" href="#version-4-3-1" title="Permalink to this headline">¶</a></h1>
<p>Version 4.3.1 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.3.1.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.3.1.tar.gz</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">install-module</span></code> sub command of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> was incorrectly
trying to install the mod_wsgi <code class="docutils literal notranslate"><span class="pre">.so</span></code> file onto itself rather than into
the Apache modules directory.</p>
<p>2. The workaround for the broken MacOS X Apache build scripts as implemented
by the <code class="docutils literal notranslate"><span class="pre">configure</span></code> script used when building using the traditional make
command wasn’t working correctly for MacOS X 10.10 (Yosemite).</p>
<p>In fixing this issue, the <code class="docutils literal notranslate"><span class="pre">configure</span></code> script has been enhanced such that
...
the developer command line tools.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added the <code class="docutils literal notranslate"><span class="pre">--add-handler</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow a
...
extension type.</p>
<p>2. Added a mechanism to limit the amount of response content that can
buffered in the Apache child worker processes when proxying back the response
from a request which had been handled in a mod_wsgi daemon process.</p>
<p>This is to combat a lack of flow control within Apache 2.2 which can cause
...
applied to both versions for consistency.</p>
<p>The default maximum on the amount of buffered content is 65536 bytes. This
can be increased by using the <code class="docutils literal notranslate"><span class="pre">proxy-buffer-size</span></code> option to the
<code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive or the <code class="docutils literal notranslate"><span class="pre">--proxy-buffer-size</span></code> option to
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. If using Apache 2.4, its own flow control mechanism
may override the value in increasing the buffer size.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.3.0.html" class="btn btn-neutral float-right" title="Version 4.3.0" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.3.2.html" class="btn btn-neutral float-left" title="Version 4.3.2" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
