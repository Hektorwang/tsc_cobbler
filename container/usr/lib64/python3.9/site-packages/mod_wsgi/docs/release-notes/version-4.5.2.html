...
<head>
  ...
  <title>Version 4.5.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.1" href="version-4.5.1.html" />
    <link rel="prev" title="Version 4.5.3" href="version-4.5.3.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.2</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.5.2.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 4.5.2<a class="headerlink" href="#version-4-5-2" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.2">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.2</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ol class="arabic simple">
<li><p>When using <code class="docutils literal notranslate"><span class="pre">--debug-mode</span></code> with <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> any additional
directories to search for Python modules, which were supplied by the
<code class="docutils literal notranslate"><span class="pre">--python-path</span></code> option, were not being added to <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.</p></li>
</ol>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.1.html" class="btn btn-neutral float-right" title="Version 4.5.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.3.html" class="btn btn-neutral float-left" title="Version 4.5.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
