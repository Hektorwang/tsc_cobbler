...
<head>
  ...
  <title>Version 4.5.12 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.11" href="version-4.5.11.html" />
    <link rel="prev" title="Version 4.5.13" href="version-4.5.13.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.12</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.12</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.12.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-12">
<h1>Version 4.5.12<a class="headerlink" href="#version-4-5-12" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.12 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.12">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.12</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>When the <code class="docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span></code> method is used to compile the module for
Windows, the <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span> <span class="pre">module-config</span></code> command was generating
the wrong DLL path for <code class="docutils literal notranslate"><span class="pre">LoadFile</span></code> directive for Python 3.4, as well as
possibly older Python versions.</p></li>
</ul>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>When using <code class="docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span></code> on Windows, in addition to looking in the
directory <code class="docutils literal notranslate"><span class="pre">C:\Apache24</span></code> for an Apache installation, it will now also
check <code class="docutils literal notranslate"><span class="pre">C:\Apache22</span></code> and <code class="docutils literal notranslate"><span class="pre">C:\Apache2</span></code>. It is recommended though that
you use Apache 2.4. If your Apache installation is elsewhere, you can
still set the <code class="docutils literal notranslate"><span class="pre">MOD_WSGI_APACHE_ROOTDIR</span></code> environment variable to its
location. The environment variable should be set in your shell before
running <code class="docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span> <span class="pre">mod_wsgi</span></code> and should be set in a way that exports
it to child processes run from the shell.</p></li>
<li><p>Added <code class="docutils literal notranslate"><span class="pre">restart-interval</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> for restarting
daemon mode processes after a set time. If <code class="docutils literal notranslate"><span class="pre">graceful-timeout</span></code> option is
...
sequence will occur. The option is also available in <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>
as <code class="docutils literal notranslate"><span class="pre">--restart-interval</span></code>.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.11.html" class="btn btn-neutral float-right" title="Version 4.5.11" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.13.html" class="btn btn-neutral float-left" title="Version 4.5.13" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
