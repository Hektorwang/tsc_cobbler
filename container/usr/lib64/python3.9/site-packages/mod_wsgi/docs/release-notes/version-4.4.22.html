...
<head>
  ...
  <title>Version 4.4.22 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.21" href="version-4.4.21.html" />
    <link rel="prev" title="Version 4.4.23" href="version-4.4.23.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.22</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.22</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.22.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-22">
<h1>Version 4.4.22<a class="headerlink" href="#version-4-4-22" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.22 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.22">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.22</a></p>
</div></blockquote>
...
<p>1. Stack traces logged at <code class="docutils literal notranslate"><span class="pre">INFO</span></code> level when a request timeout occurred
...
the process was shutting down.</p>
<p>2. When using the <code class="docutils literal notranslate"><span class="pre">--url-alias</span></code> option with <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> and the
...
the directory was a sub URL and also had a trailing slash.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. When using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, rewrite rules can now be added into the
<code class="docutils literal notranslate"><span class="pre">rewrite.conf</span></code> file located under the server root directory. An alternate
location for the rewrite rules can be specified using the <code class="docutils literal notranslate"><span class="pre">--rewrite-rules</span></code>
option.</p>
<p>Note that the rewrite rules are included within a <code class="docutils literal notranslate"><span class="pre">Directory</span></code> block of
the Apache configuration file, for the document root directory. Any rules
therefore needs to be written so as to work in this context.</p>
<p>If you need to debug the rewrite rules and are using Apache 2.4, the
easiest way to enable rewrite logging is to use the <code class="docutils literal notranslate"><span class="pre">--log-level</span></code> option
with the quoted value of <code class="docutils literal notranslate"><span class="pre">'info</span> <span class="pre">rewrite:trace8'</span></code>.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.21.html" class="btn btn-neutral float-right" title="Version 4.4.21" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.23.html" class="btn btn-neutral float-left" title="Version 4.4.23" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
