...
<head>
  ...
  <title>Version 4.4.15 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.14" href="version-4.4.14.html" />
    <link rel="prev" title="Version 4.4.16" href="version-4.4.16.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.15</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.15</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.15.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-15">
<h1>Version 4.4.15<a class="headerlink" href="#version-4-4-15" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.15 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.15">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.15</a></p>
</div></blockquote>
...
<p>1. When specifying multiple directories for the Python module search path
using the <code class="docutils literal notranslate"><span class="pre">WSGIPythonPath</span></code> directive, or the <code class="docutils literal notranslate"><span class="pre">python-path</span></code> option to
<code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>, it was failing under Python 3 due to incorrect
logging. It was therefore only possible to add a single directory.</p>
<p>2. If Apache was already running when the mod_wsgi module was enabled or
...
already running and a graceful restart, rather than a normal restart was
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.14.html" class="btn btn-neutral float-right" title="Version 4.4.14" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.16.html" class="btn btn-neutral float-left" title="Version 4.4.16" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
