...
<head>
  ...
  <title>Version 4.5.4 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.3" href="version-4.5.3.html" />
    <link rel="prev" title="Version 4.5.5" href="version-4.5.5.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.4</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.5.4.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-4">
<h1>Version 4.5.4<a class="headerlink" href="#version-4-5-4" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.4 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.4">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.4</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ol class="arabic simple">
<li><p>When using Apache 2.4 and daemon mode, the connection and request log
...
would use the same ID in logs when using the <code class="docutils literal notranslate"><span class="pre">%L</span></code> format modifier.</p></li>
<li><p>When using Apache 2.4 and daemon mode, the remote client port
information was not being cached such that log messages generated
against the request would use the port in logs when using the <code class="docutils literal notranslate"><span class="pre">%a</span></code>
format modifier.</p></li>
</ol>
</div>
...
<ol class="arabic simple">
<li><p>If <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> and <code class="docutils literal notranslate"><span class="pre">sys.stderr</span></code> are used in the context of the
thread handling a request, calls against them to log messages will be
routed back via <code class="docutils literal notranslate"><span class="pre">wsgi.errors</span></code> from the per request WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code>
...
connection and request log ID if the <code class="docutils literal notranslate"><span class="pre">%L</span></code> formatter is used in the
error log format.</p></li>
</ol>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ol class="arabic simple">
<li><p>Added new option <code class="docutils literal notranslate"><span class="pre">--error-log-format</span></code> to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow
the error log message format to be specified.</p></li>
<li><p>Pass through to the WSGI per request <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary new values
for <code class="docutils literal notranslate"><span class="pre">mod_wsgi.connection_id</span></code> and <code class="docutils literal notranslate"><span class="pre">mod_wsgi.request_id</span></code>. These are
the Apache log IDs for the connection and request that it uses in log
messages when using the <code class="docutils literal notranslate"><span class="pre">%L</span></code> format modifier. This only applies to
Apache 2.4 and later.</p></li>
</ol>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.3.html" class="btn btn-neutral float-right" title="Version 4.5.3" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.5.html" class="btn btn-neutral float-left" title="Version 4.5.5" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
