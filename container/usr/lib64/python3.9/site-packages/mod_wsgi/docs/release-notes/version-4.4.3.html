...
<head>
  ...
  <title>Version 4.4.3 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.2" href="version-4.4.2.html" />
    <link rel="prev" title="Version 4.4.4" href="version-4.4.4.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.3</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.3.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-3">
<h1>Version 4.4.3<a class="headerlink" href="#version-4-4-3" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.3 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.3">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.3</a></p>
</div></blockquote>
<div class="section" id="known-issues">
<h2>Known Issues<a class="headerlink" href="#known-issues" title="Permalink to this headline">¶</a></h2>
<p>1. Although the makefiles for building mod_wsgi on Windows have now been
...
<ul class="simple">
<li><p><a class="reference external" href="http://www.lfd.uci.edu/~gohlke/pythonlibs/#mod_wsgi">http://www.lfd.uci.edu/~gohlke/pythonlibs/#mod_wsgi</a></p></li>
</ul>
</div>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">--lang</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> has been deprecated. Any
default language locale setting should be set exclusively using the
<code class="docutils literal notranslate"><span class="pre">--locale</span></code> option.</p>
<p>2. The behaviour of the <code class="docutils literal notranslate"><span class="pre">--locale</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> has
changed. Previously if this option was not defined, then both of the locales
<code class="docutils literal notranslate"><span class="pre">en_US.UTF-8</span></code> and <code class="docutils literal notranslate"><span class="pre">C.UTF-8</span></code> have at times been hardwired as the default
locale. These locales are though not always present. As a consequence, a
new algorithm is now used.</p>
<p>If the <code class="docutils literal notranslate"><span class="pre">--locale</span></code> option is supplied, the argument will be used as the
locale. If no argument is supplied, the default locale for the executing
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> process will be used. If that however is <code class="docutils literal notranslate"><span class="pre">C</span></code> or
<code class="docutils literal notranslate"><span class="pre">POSIX</span></code>, then an attempt will be made to use either the <code class="docutils literal notranslate"><span class="pre">en_US.UTF-8</span></code>
or <code class="docutils literal notranslate"><span class="pre">C.UTF-8</span></code> locales and if that is not possible only then fallback to
the default locale of the <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> process.</p>
<p>In other words, unless you override the default language locale, an attempt
is made to use an English language locale with <code class="docutils literal notranslate"><span class="pre">UTF-8</span></code> encoding.</p>
<p>3. Unless the process name is overridden using <code class="docutils literal notranslate"><span class="pre">--process-name</span></code> option
to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, the Apache parent and child worker process will
be given a name such as <code class="docutils literal notranslate"><span class="pre">httpd</span> <span class="pre">(mod_wsgi-express)</span></code> making them more
easily distinguishable from a traditional Apache installation.</p>
</div>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<p>1. The <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> script would fail on startup if the user had
...
occurs, the group will now be specified as <code class="docutils literal notranslate"><span class="pre">#nnn</span></code> where <code class="docutils literal notranslate"><span class="pre">nnn</span></code> is the
group ID.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added <code class="docutils literal notranslate"><span class="pre">--process-name</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow the
name of the Apache parent process to be overridden as it would be displayed
in <code class="docutils literal notranslate"><span class="pre">ps</span></code>. This is necessary under some process manager systems where it
looks for a certain name, but with shell script wrappers and exec calls
happening around <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> the name would change.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.2.html" class="btn btn-neutral float-right" title="Version 4.4.2" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.4.html" class="btn btn-neutral float-left" title="Version 4.4.4" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
