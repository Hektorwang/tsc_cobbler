...
<head>
  ...
  <title>Version 4.5.19 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.18" href="version-4.5.18.html" />
    <link rel="prev" title="Version 4.5.20" href="version-4.5.20.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.19</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.19</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.19.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-19">
<h1>Version 4.5.19<a class="headerlink" href="#version-4-5-19" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.19 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.19">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.19</a></p>
</div></blockquote>
...
<ul class="simple">
<li><p>When using the Django management command integration of
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, allow the <code class="docutils literal notranslate"><span class="pre">--working-directory</span></code> option to
override the calculated directory. This is necessary to cope with
where the meaning of <code class="docutils literal notranslate"><span class="pre">BASE_DIR</span></code> in the Django settings file has been
changed from the accepted convention of it being the parent directory
of the Django project.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.18.html" class="btn btn-neutral float-right" title="Version 4.5.18" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.20.html" class="btn btn-neutral float-left" title="Version 4.5.20" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
