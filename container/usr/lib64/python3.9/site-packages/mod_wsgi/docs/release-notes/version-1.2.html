...
<head>
  ...
  <title>Version 1.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 1.1" href="version-1.1.html" />
    <link rel="prev" title="Version 1.3" href="version-1.3.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-1.2.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 1.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-1.2.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-1.2.tar.gz</a></p>
</div></blockquote>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. When headers are flushed by mod_wsgi is not strictly compliant with
the WSGI specification. In particular the specification says:</p>
<blockquote>
<div><p>The start_response callable must not actually transmit the response
...
Content-Length of zero.)</p>
</div></blockquote>
<p>In mod_wsgi when an iterable was returned from the application, the headers
were being flushed even if the string was empty. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=35">http://code.google.com/p/modwsgi/issues/detail?id=35</a></p>
</div></blockquote>
<p>2. Calling start_response() a second time to supply exception information
...
See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=36">http://code.google.com/p/modwsgi/issues/detail?id=36</a></p>
</div></blockquote>
<p>3. Added additional logging to highlight instance where WSGI script file was
...
fails due to inadequate permissions or other reasons.</p>
<p>4. Fixed a few instances where logging via request object before fake
...
with Apache child process had tried to communicate with the daemon process.</p>
<p>5. Fixed problem when Apache 1.3 or 2.0 was being used, where the
...
application. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=39">http://code.google.com/p/modwsgi/issues/detail?id=39</a></p>
</div></blockquote>
<p>In particular, for a URL with the repeating slash the application group
...
the process.</p>
<p>Besides the additional memory use, this would in general not be an issue
...
URL would not access the same application data as those without.</p>
<p>Note, this problem could only arise where WSGIApplicationGroup directive
...
the default.</p>
<p>6. Fixed problem whereby status of sub processes created from mod_wsgi
daemon processes were not being caught properly. This was because mod_wsgi
was wrongly blocking SIGCHLD signal. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=38">http://code.google.com/p/modwsgi/issues/detail?id=38</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-1.1.html" class="btn btn-neutral float-right" title="Version 1.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-1.3.html" class="btn btn-neutral float-left" title="Version 1.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
