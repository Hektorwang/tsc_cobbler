...
<head>
  ...
  <title>Version 4.5.6 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.5" href="version-4.5.5.html" />
    <link rel="prev" title="Version 4.5.7" href="version-4.5.7.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.6</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.5.6.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-6">
<h1>Version 4.5.6<a class="headerlink" href="#version-4-5-6" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.6 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.6">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.6</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ol class="arabic simple">
<li><p>Reinstanted change to associate any messages logged via <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code>
and <code class="docutils literal notranslate"><span class="pre">sys.stderr</span></code> back to the request so that Apache can log them
...
Python 3.</p></li>
<li><p>When using Apache 2.4 use new style <code class="docutils literal notranslate"><span class="pre">Require</span></code> directive instead of
older <code class="docutils literal notranslate"><span class="pre">Order</span></code> and <code class="docutils literal notranslate"><span class="pre">Allow</span></code> when setting up access controls for
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. This fixes a problem where when using
<code class="docutils literal notranslate"><span class="pre">--include-file</span></code> and <code class="docutils literal notranslate"><span class="pre">Require</span></code> directive was being used. Precedence
...
custom configuration.</p></li>
<li><p>Django 1.10 requires that management commands use argparse style
options but <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> uses optparse style options. Can no
...
until drop Python 2.6 support. Changes stop <code class="docutils literal notranslate"><span class="pre">runmodwsgi</span></code> management
command failing when using Django 1.10+.</p></li>
</ol>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ol class="arabic">
<li><p>Added <code class="docutils literal notranslate"><span class="pre">startup-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive.
...
The option is exposed via <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> with a default value
of 15 seconds.</p>
<p>This would be used where running the Django web framework and there is
...
should be fine.</p>
<p>Do note that this option should preferably only be used where the one
...
delegate each WSGI application to a distinct daemon process group.</p>
</li>
</ol>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.5.html" class="btn btn-neutral float-right" title="Version 4.5.5" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.7.html" class="btn btn-neutral float-left" title="Version 4.5.7" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
