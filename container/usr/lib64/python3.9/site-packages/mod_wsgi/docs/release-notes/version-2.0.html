...
<head>
  ...
  <title>Version 2.0 &mdash; mod_wsgi 4.7.1 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-2.0.rst.txt" rel="nofollow"> View page source</a>
...
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-2.0.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-2.0.tar.gz</a></p>
</div></blockquote>
...
<ul class="simple">
<li><p><a class="reference internal" href="version-1.1.html"><span class="doc">Version 1.1</span></a></p></li>
<li><p><a class="reference internal" href="version-1.2.html"><span class="doc">Version 1.2</span></a></p></li>
<li><p><a class="reference internal" href="version-1.3.html"><span class="doc">Version 1.3</span></a></p></li>
</ul>
...
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/wiki/ReloadingSourceCode">http://code.google.com/p/modwsgi/wiki/ReloadingSourceCode</a></p>
</div></blockquote>
...
at:</p>
<blockquote>
<div><p><a class="reference external" href="https://bitbucket.org/grahamdumpleton/apswigpy/wiki/Home">https://bitbucket.org/grahamdumpleton/apswigpy/wiki/Home</a></p>
</div></blockquote>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">apache.httpd</span><span class="o">,</span> <span class="nn">apache.http_core</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">AuthType</span> <span class="n">Digest</span>
<span class="n">AuthName</span> <span class="s2">&quot;Top Secret&quot;</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">md5</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">&lt;</span><span class="n">AuthnProviderAlias</span> <span class="n">wsgi</span> <span class="n">django</span><span class="o">&gt;</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">django</span><span class="o">-</span><span class="n">admin</span>
...
the auth provider:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">apache.httpd</span>
...
<p>For more details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/wiki/AccessControlMechanisms">http://code.google.com/p/modwsgi/wiki/AccessControlMechanisms</a></p>
</div></blockquote>
...
functions:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">process_group</span><span class="p">(</span><span class="n">environ</span><span class="p">):</span>
...
For example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">trac</span> <span class="n">processes</span><span class="o">=</span><span class="mi">1</span> <span class="n">threads</span><span class="o">=</span><span class="mi">15</span> \
...
example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">example</span> <span class="n">processes</span><span class="o">=</span><span class="mi">2</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span> <span class="n">stack</span><span class="o">-</span><span class="n">size</span><span class="o">=</span><span class="mi">524288</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="c1"># workingenv</span>
...
<code class="docutils literal notranslate"><span class="pre">PYTHONPATH</span></code> environment variable. Instead it now calls
<code class="docutils literal notranslate"><span class="pre">site.addsitedir()</span></code> for any specified directories, thus triggering the
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">turbogears</span> <span class="n">processes</span><span class="o">=</span><span class="mi">5</span> <span class="n">threads</span><span class="o">=</span><span class="mi">1</span> \
...
<p>For more details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/wiki/VirtualEnvironments">http://code.google.com/p/modwsgi/wiki/VirtualEnvironments</a></p>
</div></blockquote>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIAccessScript</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">wsgi</span><span class="o">/</span><span class="n">script</span><span class="o">/</span><span class="n">access</span><span class="o">.</span><span class="n">wsgi</span>
</pre></div>
</div>
<p>The name of the function that must exist in the script file is ‘allow_access()’.
It must return True or False:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">allow_access</span><span class="p">(</span><span class="n">environ</span><span class="p">,</span> <span class="n">host</span><span class="p">):</span>
...
directive:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIAccessScript</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">wsgi</span><span class="o">/</span><span class="n">script</span><span class="o">/</span><span class="n">access</span><span class="o">.</span><span class="n">wsgi</span> <span class="n">application</span><span class="o">-</span><span class="n">group</span><span class="o">=</span><span class="n">admin</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIImportScript</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">wsgi</span><span class="o">/</span><span class="n">script</span><span class="o">/</span><span class="n">import</span><span class="o">.</span><span class="n">wsgi</span> \
...
status was being returned instead of a 500 error.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-1.6.html" class="btn btn-neutral float-right" title="Version 1.6" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.1.html" class="btn btn-neutral float-left" title="Version 2.1" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
