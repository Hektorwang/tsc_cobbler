...
<head>
  ...
  <title>Version 4.6.3 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.6.2" href="version-4.6.2.html" />
    <link rel="prev" title="Version 4.6.4" href="version-4.6.4.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.6.3</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.6.3.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-6-3">
<h1>Version 4.6.3<a class="headerlink" href="#version-4-6-3" title="Permalink to this headline">¶</a></h1>
<p>Version 4.6.3 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.3">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.3</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>When compiled for Python 2.6, when run mod_wsgi would fail to load into
Apache due to misisng symbol <code class="docutils literal notranslate"><span class="pre">PyFrame_GetLineNumber</span></code>. This was only
...
traces on shutdown due to request timeout.</p></li>
<li><p>Installing mod_wsgi on Windows would fail as hadn’t exclude mod_wsgi
daemon mode specific code from Windows build. This would result in compile
time error about <code class="docutils literal notranslate"><span class="pre">wsgi_daemon_process</span></code> being undefined. This problem
was introduced to Windows in version 4.6.0.</p></li>
<li><p>When using <code class="docutils literal notranslate"><span class="pre">runmodwsgi</span></code> management command integration for Django, the
...
path based on what <code class="docutils literal notranslate"><span class="pre">WSGI_APPLICATION</span></code> is set to in the Django settings
module. This means the file is imported as part of package for the project
and relative imports will work.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.6.2.html" class="btn btn-neutral float-right" title="Version 4.6.2" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.6.4.html" class="btn btn-neutral float-left" title="Version 4.6.4" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
