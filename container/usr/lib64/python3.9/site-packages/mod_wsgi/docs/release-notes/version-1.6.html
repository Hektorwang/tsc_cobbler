...
<head>
  ...
  <title>Version 1.6 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 1.5" href="version-1.5.html" />
    <link rel="prev" title="Version 2.0" href="version-2.0.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-1.6.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 1.6 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-1.6.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-1.6.tar.gz</a></p>
</div></blockquote>
<p><strong>Note that this is a quick followup to version 1.5 of mod_wsgi to rectify
significant problem introduced by that release. You should therefore also
refer to:</strong></p>
<ul class="simple">
<li><p><a class="reference internal" href="version-1.5.html"><span class="doc">Version 1.5</span></a>.</p></li>
</ul>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Fixed problem introduced in version 1.5 of mod_wsgi whereby use of
...
<div><p><a class="reference external" href="http://groups.google.com/group/modwsgi/browse_frm/thread/79a86f8faffe7dcf">http://groups.google.com/group/modwsgi/browse_frm/thread/79a86f8faffe7dcf</a></p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-1.5.html" class="btn btn-neutral float-right" title="Version 1.5" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.0.html" class="btn btn-neutral float-left" title="Version 2.0" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
