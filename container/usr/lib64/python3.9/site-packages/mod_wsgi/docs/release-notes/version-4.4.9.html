...
<head>
  ...
  <title>Version 4.4.9 &mdash; mod_wsgi 4.7.1 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.9.rst.txt" rel="nofollow"> View page source</a>
...
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.9">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.9</a></p>
</div></blockquote>
<p>For details on the availability of Windows binaries see:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/tree/master/win32">https://github.com/GrahamDumpleton/mod_wsgi/tree/master/win32</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">--proxy-url-alias</span></code> option of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> has been
superseded by the <code class="docutils literal notranslate"><span class="pre">--proxy-mount-point</span></code> option. This option now should
...
process. This avoids the requirement of setting <code class="docutils literal notranslate"><span class="pre">WSGIRestrictSignal</span></code> to
<code class="docutils literal notranslate"><span class="pre">Off</span></code> if wanting to setup new signal handlers from a forked child process.</p>
...
embedded mode, it is still a good idea to set signal handles for <code class="docutils literal notranslate"><span class="pre">SIGINT</span></code>,
<code class="docutils literal notranslate"><span class="pre">SIGTERM</span></code> and <code class="docutils literal notranslate"><span class="pre">SIGUSR1</span></code> back to <code class="docutils literal notranslate"><span class="pre">SIG_DFL</span></code> using <code class="docutils literal notranslate"><span class="pre">signal.signal()</span></code>
...
<p>1. Added <code class="docutils literal notranslate"><span class="pre">--hsts-policy</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow a HSTS
(<code class="docutils literal notranslate"><span class="pre">Strict-Transport-Security</span></code>) policy response header to be specified which
should be included when the <code class="docutils literal notranslate"><span class="pre">--https-only</span></code> option is used to ensure that
the site only accepts HTTPS connections.</p>
<p>2. Added <code class="docutils literal notranslate"><span class="pre">WSGITrustedProxyHeaders</span></code> directive. This allows you to specify
...
them will be used to fix up the values in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary
...
<code class="docutils literal notranslate"><span class="pre">X-Forwarded-Proto</span></code>, <code class="docutils literal notranslate"><span class="pre">X-Forwarded-Scheme</span></code> and <code class="docutils literal notranslate"><span class="pre">X-Scheme</span></code>. It is
expected that the value these supply will be <code class="docutils literal notranslate"><span class="pre">http</span></code> or <code class="docutils literal notranslate"><span class="pre">https</span></code>. When it
is <code class="docutils literal notranslate"><span class="pre">https</span></code>, the <code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code> value in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code>
dictionary will be overridden to be <code class="docutils literal notranslate"><span class="pre">https</span></code>.</p>
<p>Alternate headers accepted are <code class="docutils literal notranslate"><span class="pre">X-Forwarded-HTTPS</span></code>, <code class="docutils literal notranslate"><span class="pre">X-Forwarded-SSL</span></code>
and <code class="docutils literal notranslate"><span class="pre">X-HTTPS</span></code>. If these are passed, the value needs to be <code class="docutils literal notranslate"><span class="pre">On</span></code>,
<code class="docutils literal notranslate"><span class="pre">true</span></code> or <code class="docutils literal notranslate"><span class="pre">1</span></code>. A case insensitive match is performed. When matched, the
<code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code> value in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary will be
overridden to be <code class="docutils literal notranslate"><span class="pre">https</span></code>.</p>
<p>The header names which are accepted for specifying the target host are
<code class="docutils literal notranslate"><span class="pre">X-Forwarded-Host</span></code> and <code class="docutils literal notranslate"><span class="pre">X-Host</span></code>. When found, the value will be used
to override the <code class="docutils literal notranslate"><span class="pre">HTTP_HOST</span></code> value in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary.</p>
<p>The sole header name accepted for specifying the front end proxy server
name is <code class="docutils literal notranslate"><span class="pre">X-Fowarded-Server</span></code>. When found, the value will be used to
override the <code class="docutils literal notranslate"><span class="pre">SERVER_NAME</span></code> value in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary.</p>
<p>The sole header name accepted for specifying the front end proxy server
port is <code class="docutils literal notranslate"><span class="pre">X-Fowarded-Port</span></code>. When found, the value will be used to
override the <code class="docutils literal notranslate"><span class="pre">SERVER_PORT</span></code> value in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary.</p>
<p>The header names accepted for specifying the client IP address are
<code class="docutils literal notranslate"><span class="pre">X-Forwarded-For</span></code> and <code class="docutils literal notranslate"><span class="pre">X-Real-IP</span></code>. When <code class="docutils literal notranslate"><span class="pre">X-Forwarded-For</span></code> is used
then the first IP address listed in the header value will be used. For
<code class="docutils literal notranslate"><span class="pre">X-Real-IP</span></code> only one IP address should be given. When found, the value
will be used to override the <code class="docutils literal notranslate"><span class="pre">REMOTE_ADDR</span></code> value in the WSGI <code class="docutils literal notranslate"><span class="pre">environ</span></code>
dictionary.</p>
...
added in a future version. When that is available and <code class="docutils literal notranslate"><span class="pre">X-Forwarded-For</span></code>
...
<code class="docutils literal notranslate"><span class="pre">X-Script-Name</span></code> and <code class="docutils literal notranslate"><span class="pre">X-Forwarded-Script-Name</span></code>. When found, the value
will override the <code class="docutils literal notranslate"><span class="pre">SCRIPT_NAME</span></code> value in the <code class="docutils literal notranslate"><span class="pre">WSGI</span></code> environ dictionary.</p>
<p>When using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> the equivalent command line option is
<code class="docutils literal notranslate"><span class="pre">--trust-proxy-header</span></code>. The option can be used multiple times to specify
more than one header.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.8.html" class="btn btn-neutral float-right" title="Version 4.4.8" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.10.html" class="btn btn-neutral float-left" title="Version 4.4.10" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
