...
<head>
  ...
  <title>Version 4.4.23 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.22" href="version-4.4.22.html" />
    <link rel="prev" title="Version 4.5.0" href="version-4.5.0.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.23</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.23</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.23.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-23">
<h1>Version 4.4.23<a class="headerlink" href="#version-4-4-23" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.23 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.23">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.23</a></p>
</div></blockquote>
...
<p>1. Added the <code class="docutils literal notranslate"><span class="pre">--ssl-certificate-chain-file</span></code> option to
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, for specifying the path to a file containing the
certificates of Certification Authorities (CA) which form the certificate
chain of the server certificate. This is equivalent to having used the
Apache <code class="docutils literal notranslate"><span class="pre">SSLCertificateChainFile</span></code> directive.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.22.html" class="btn btn-neutral float-right" title="Version 4.4.22" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.0.html" class="btn btn-neutral float-left" title="Version 4.5.0" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
