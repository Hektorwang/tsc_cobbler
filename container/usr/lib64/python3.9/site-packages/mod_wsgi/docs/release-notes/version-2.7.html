...
<head>
  ...
  <title>Version 2.7 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 2.6" href="version-2.6.html" />
    <link rel="prev" title="Version 2.8" href="version-2.8.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 2.7</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-2.7.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 2.7<a class="headerlink" href="#version-2-7" title="Permalink to this headline">¶</a></h1>
<p>Version 2.7 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-2.7.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-2.7.tar.gz</a></p>
</div></blockquote>
...
<p>1. Set timeout on socket connection between Apache server child process and
...
<p>1. Wasn’t possible to set CFLAGS from environment variable when running the
‘configure’ script.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-2.6.html" class="btn btn-neutral float-right" title="Version 2.6" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.8.html" class="btn btn-neutral float-left" title="Version 2.8" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
