...
<head>
  ...
  <title>Version 4.4.11 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.10" href="version-4.4.10.html" />
    <link rel="prev" title="Version 4.4.12" href="version-4.4.12.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.11</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.11</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.11.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-11">
<h1>Version 4.4.11<a class="headerlink" href="#version-4-4-11" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.11 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.11">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.11</a></p>
</div></blockquote>
...
<p>1. No provision was made for operating systems with a very low limit on the
number of separate data blocks that could be passed to system <code class="docutils literal notranslate"><span class="pre">writev()</span></code>
...
more than a small number of headers.</p>
<p>2. When installing the <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code> package using <code class="docutils literal notranslate"><span class="pre">pip</span></code> and rather
than activating the virtual environment you were referring to <code class="docutils literal notranslate"><span class="pre">pip</span></code> by
path from the <code class="docutils literal notranslate"><span class="pre">bin</span></code> directory, the <code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code> package which
had already been installed into the virtual environment would not be
detected.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added the <code class="docutils literal notranslate"><span class="pre">--service-log</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> for
...
specific log directory if specified.</p>
<p>2. Set various environment variables from <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to identify
...
a web application can modify it’s behaviour when <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> is
being used, or being used in specific ways. The environment variables which
are set are:</p>
<ul class="simple">
<li><p><em>MOD_WSGI_EXPRESS</em> - Indicates that <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> is being used.</p></li>
<li><p><em>MOD_WSGI_SERVER_NAME</em> - The primary server host name for the site.</p></li>
<li><p><em>MOD_WSGI_SERVER_ALIASES</em> - Secondary host names the site is known by.</p></li>
<li><p><em>MOD_WSGI_RELOADER_ENABLED</em> - Indicates if source code reloading enabled.</p></li>
<li><p><em>MOD_WSGI_DEBUG_MODE</em> - Indicates if debug mode has been enabled.</p></li>
<li><p><em>MOD_WSGI_DEBUGGER_ENABLED</em> - Indicates pdb debugger has been enabled.</p></li>
<li><p><em>MOD_WSGI_COVERAGE_ENABLED</em> - Indicates if coverage analysis has been
enabled.</p></li>
<li><p><em>MOD_WSGI_PROFILER_ENABLED</em> - Indicates if code profiling has been enabled.</p></li>
<li><p><em>MOD_WSGI_RECORDER_ENABLED</em> - Indicates if request/response recording
enabled.</p></li>
<li><p><em>MOD_WSGI_GDB_ENABLED</em> - Indicates if gdb process crash debugging enabled.</p></li>
</ul>
<p>For any environment variable indicating a feature has been enabled, it
will be set when enabled and have the value ‘true’.</p>
<p>For the list of server aliases, it will be a space separated list of host
names.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.10.html" class="btn btn-neutral float-right" title="Version 4.4.10" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.12.html" class="btn btn-neutral float-left" title="Version 4.4.12" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
