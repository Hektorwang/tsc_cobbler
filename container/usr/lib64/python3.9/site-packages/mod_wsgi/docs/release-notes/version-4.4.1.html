...
<head>
  ...
  <title>Version 4.4.1 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.0" href="version-4.4.0.html" />
    <link rel="prev" title="Version 4.4.2" href="version-4.4.2.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.1</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.1.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-1">
<h1>Version 4.4.1<a class="headerlink" href="#version-4-4-1" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.1 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.1">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.1</a></p>
</div></blockquote>
...
<p>1. Process crashes could occur when request content had been consumed by
the WSGI application. The trigger was when the Python <code class="docutils literal notranslate"><span class="pre">wsgi.input</span></code> was
still in existence after the web request had finished. The destruction of
the <code class="docutils literal notranslate"><span class="pre">wsgi.input</span></code> object was accessing memory which had already been
...
<p>1. When an error occurs in writing back a response to the HTTP client,
...
by Apache itself from the core_output_filter, so that may still appear.</p>
<p>2. The <code class="docutils literal notranslate"><span class="pre">--profiler-output-file</span></code> option for <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> was
changed to <code class="docutils literal notranslate"><span class="pre">--profiler-directory</span></code> and now refers to a directory, with
individual pstats files being added to the directory for each session
rather than reusing the same name all the time.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added the <code class="docutils literal notranslate"><span class="pre">--server-mpm</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. With this
...
for MPMs is ‘event’, ‘worker’ and finally ‘prefork’.</p>
<p>2. Added <code class="docutils literal notranslate"><span class="pre">static</span></code> as an option for <code class="docutils literal notranslate"><span class="pre">--application-type</span></code> when running
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. When set as <code class="docutils literal notranslate"><span class="pre">static</span></code>, only static files will be
...
these cases a normal HTTP 404 response will be returned instead.</p>
<p>3. Added <code class="docutils literal notranslate"><span class="pre">--host-access-script</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow
a Python script to be provided which can control host access. This uses
the <code class="docutils literal notranslate"><span class="pre">WSGIAccessScript</span></code> directive and the handler script should define an
<code class="docutils literal notranslate"><span class="pre">allow_access(environ,</span> <span class="pre">host)</span></code> function which returns <code class="docutils literal notranslate"><span class="pre">True</span></code> if access is
allowed or <code class="docutils literal notranslate"><span class="pre">False</span></code> if blocked.</p>
<p>4. Added <code class="docutils literal notranslate"><span class="pre">--debugger-startup</span></code> option to be used in conjunction with
the <code class="docutils literal notranslate"><span class="pre">--enable-debugger</span></code> option of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> when in debug mode.
The option will cause the debugger to be activated on server start before
any requests are handled to allow breakpoints to be set.</p>
<p>5. Added a <code class="docutils literal notranslate"><span class="pre">socket-user</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow the
...
application.</p>
<p>6. Added a <code class="docutils literal notranslate"><span class="pre">--enable-recorder</span></code> option for enabling request recording when
also using debug mode.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.0.html" class="btn btn-neutral float-right" title="Version 4.4.0" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.2.html" class="btn btn-neutral float-left" title="Version 4.4.2" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
