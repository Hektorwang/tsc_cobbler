...
<head>
  ...
  <title>Version 4.2.0 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.1.3" href="version-4.1.3.html" />
    <link rel="prev" title="Version 4.2.1" href="version-4.2.1.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.2.0</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.2.0.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 4.2.0<a class="headerlink" href="#version-4-2-0" title="Permalink to this headline">¶</a></h1>
<p>Version 4.2.0 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.0.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.0.tar.gz</a></p>
</div></blockquote>
...
<p>1. Added <code class="docutils literal notranslate"><span class="pre">mod_wsgi.server_metrics()</span></code> function which provides access to a
...
<p>Note that if <code class="docutils literal notranslate"><span class="pre">mod_status</span></code> is not loaded into Apache, or the compile time
configuration of Apache prohibits the scoreboard from being available, this
function will return <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<p>Also be aware that only partial information about worker status, and no
information about requests, will be returned if the <code class="docutils literal notranslate"><span class="pre">ExtendedStatus</span></code>
directive is not also set to <code class="docutils literal notranslate"><span class="pre">On</span></code>.</p>
<p>Although <code class="docutils literal notranslate"><span class="pre">mod_status</span></code> needs to be loaded, it is not necessary to enable
any URL to expose the server status page.</p>
<p>2. Added support for a platform plugin for New Relic to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>
which will report server status information up to New Relic if the
<code class="docutils literal notranslate"><span class="pre">--with-newrelic</span></code> option is supplied when running mod_wsgi express.</p>
<p>That same option also enables the New Relic Python agent. If you only want
one or the other, you can instead use the <code class="docutils literal notranslate"><span class="pre">--with-newrelic-agent</span></code> and
<code class="docutils literal notranslate"><span class="pre">--with-newrelic-platform</span></code> options.</p>
<p>The feature of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> for reporting data up to the New Relic
Platform is dependent upon the separate <code class="docutils literal notranslate"><span class="pre">mod_wsgi-metrics</span></code> package being
installed.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.1.3.html" class="btn btn-neutral float-right" title="Version 4.1.3" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.2.1.html" class="btn btn-neutral float-left" title="Version 4.2.1" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
