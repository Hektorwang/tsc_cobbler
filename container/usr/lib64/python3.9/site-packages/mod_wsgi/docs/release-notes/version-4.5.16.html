...
<head>
  ...
  <title>Version 4.5.16 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.15" href="version-4.5.15.html" />
    <link rel="prev" title="Version 4.5.17" href="version-4.5.17.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.16</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.16</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.16.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-16">
<h1>Version 4.5.16<a class="headerlink" href="#version-4-5-16" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.16 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.16">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.16</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">WSGIDontWriteBytecode</span></code> option wasn’t available when using Python 3.3
and later. This feature of Python wasn’t in initial Python 3 versions, but
when was later added, mod_wsgi was updated to allow it.</p></li>
<li><p>The feature behind the <code class="docutils literal notranslate"><span class="pre">startup-timeout</span></code> option of <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>
...
file could not be loaded successfully by the specified timeout.</p></li>
<li><p>When using <code class="docutils literal notranslate"><span class="pre">WSGIImportScript</span></code>, or <code class="docutils literal notranslate"><span class="pre">WSGIScriptAlias</span></code> with both the
<code class="docutils literal notranslate"><span class="pre">process-group</span></code> and <code class="docutils literal notranslate"><span class="pre">application-group</span></code> options, with the intent of
preloading a WSGI script file, the ability to reach across to a daemon
process defined in a different virtual host with same <code class="docutils literal notranslate"><span class="pre">ServerName</span></code> was
always failing and the target daemon process group would be flagged as
not accessible when instead it should have been.</p></li>
</ul>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>Added <code class="docutils literal notranslate"><span class="pre">--allow-override</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow use of
a <code class="docutils literal notranslate"><span class="pre">.htaccess</span></code> in document root directory and any directories mapped
using a URL alias. The argument to the directive should be the directive
type which can be overridden in the <code class="docutils literal notranslate"><span class="pre">.htaccess</span></code> file. The option can be
used more than once if needing to allow overriding of more than one
directive type. Argument can be anything allowed by <code class="docutils literal notranslate"><span class="pre">AllowOverride</span></code>
directive.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.15.html" class="btn btn-neutral float-right" title="Version 4.5.15" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.17.html" class="btn btn-neutral float-left" title="Version 4.5.17" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
