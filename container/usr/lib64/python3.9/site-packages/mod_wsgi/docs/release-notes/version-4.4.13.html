...
<head>
  ...
  <title>Version 4.4.13 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.12" href="version-4.4.12.html" />
    <link rel="prev" title="Version 4.4.14" href="version-4.4.14.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.13</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.13</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.13.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-13">
<h1>Version 4.4.13<a class="headerlink" href="#version-4-4-13" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.13 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.13">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.13</a></p>
</div></blockquote>
...
<p>1. The pip installable ‘mod_wsgi’ package was failing to install on
OpenShift and Heroku as <code class="docutils literal notranslate"><span class="pre">mod_wsgi-apxs</span></code> isn’t used for tarball based
installs.</p>
</div>
...
<p>1. For <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, only the web server type is now shown in the
server tokens sent back in the <code class="docutils literal notranslate"><span class="pre">Server</span></code> response header. This prevents
users from knowing any specifics and thus using that to determine possible
vulnerabilities.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Set environment variables from <code class="docutils literal notranslate"><span class="pre">apachectl</span></code> for <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>
...
variables are:</p>
<ul class="simple">
<li><p><em>MOD_WSGI_SERVER_ROOT</em> - This is the directory where the generated
configuration files, startup scripts, etc were placed.</p></li>
<li><p><em>MOD_WSGI_WORKING_DIRECTORY</em> - This is the directory which will be used
as the current working directory of the process. Would default to being
the same as <code class="docutils literal notranslate"><span class="pre">MOD_WSGI_SERVER_ROOT</span></code> if not overridden.</p></li>
<li><p><em>MOD_WSGI_LISTENER_HOST</em> - The host name or IP on which connections are
being accepted. This should only be used if the Apache configuration
variable <code class="docutils literal notranslate"><span class="pre">MOD_WSGI_WITH_LISTENER_HOST</span></code> is defined.</p></li>
<li><p><em>MOD_WSGI_HTTP_PORT</em> - The port on which HTTP connections are being accepted.</p></li>
<li><p><em>MOD_WSGI_HTTPS_PORT</em> - The port on which HTTPS connections are being
accepted. This should only be used if the Apache configuration variable
<code class="docutils literal notranslate"><span class="pre">MOD_WSGI_WITH_HTTPS</span></code> is defined.</p></li>
<li><p><em>MOD_WSGI_MODULES_DIRECTORY</em> - The directory where the Apache modules are
installed.</p></li>
<li><p><em>MOD_WSGI_RUN_USER</em> - The user that the WSGI application will be run as.</p></li>
<li><p><em>MOD_WSGI_RUN_GROUP</em> - The group that the WSGI application will be run as.</p></li>
</ul>
<p>2. Added <code class="docutils literal notranslate"><span class="pre">X-Client-IP</span></code> to list of possible trusted headers indicating the
true remote address of client when passing through a proxy.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.12.html" class="btn btn-neutral float-right" title="Version 4.4.12" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.14.html" class="btn btn-neutral float-left" title="Version 4.4.14" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
