...
<head>
  ...
  <title>Version 4.6.5 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.6.4" href="version-4.6.4.html" />
    <link rel="prev" title="Version 4.6.6" href="version-4.6.6.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.6.5</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.6.5.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-6-5">
<h1>Version 4.6.5<a class="headerlink" href="#version-4-6-5" title="Permalink to this headline">¶</a></h1>
<p>Version 4.6.5 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.5">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.5</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>When running <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> and serving up static files from the
document root, and the WSGI application was mounted at a sub URL using
<code class="docutils literal notranslate"><span class="pre">--mount-point</span></code>, the static files in the document root outside of the
mount point for the WSGI application would no longer be accessible.</p></li>
<li><p>If no system mime types file can be found, fall back to <code class="docutils literal notranslate"><span class="pre">/dev/null</span></code>
so that Apache can still at least start up.</p></li>
</ul>
</div>
...
<ul class="simple">
<li><p>On macOS, use <code class="docutils literal notranslate"><span class="pre">/var/tmp</span></code> as default parent directory for server root
directory rather than value of <code class="docutils literal notranslate"><span class="pre">$TMPDIR</span></code>. The latter can produce a
path which is too long and UNIX socket cannot be written there.</p></li>
</ul>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>Now possible to use <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> in an a <code class="docutils literal notranslate"><span class="pre">zipapp</span></code> created using
<code class="docutils literal notranslate"><span class="pre">shiv</span></code>. This entailed a special workaround to detect when <code class="docutils literal notranslate"><span class="pre">shiv</span></code> was
used, so that the unpacked <code class="docutils literal notranslate"><span class="pre">site-packages</span></code> directory could be added to
the Python module search path for <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.6.4.html" class="btn btn-neutral float-right" title="Version 4.6.4" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.6.6.html" class="btn btn-neutral float-left" title="Version 4.6.6" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
