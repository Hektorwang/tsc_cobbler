...
<head>
  ...
  <title>Version 3.5 &mdash; mod_wsgi 4.7.1 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-3.5.rst.txt" rel="nofollow"> View page source</a>
...
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/3.5.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/3.5.tar.gz</a></p>
</div></blockquote>
...
<li><p>Local privilege escalation when using daemon mode. (CVE-2014-0240)</p></li>
</ol>
...
<blockquote>
<div><ul class="simple">
<li><p><a class="reference external" href="http://man7.org/linux/man-pages/man2/setuid.2.html">http://man7.org/linux/man-pages/man2/setuid.2.html</a></p></li>
<li><p><a class="reference external" href="http://pubs.opengroup.org/onlinepubs/009695399/functions/setuid.html">http://pubs.opengroup.org/onlinepubs/009695399/functions/setuid.html</a></p></li>
</ul>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p><a class="reference external" href="https://groups.google.com/forum/?fromgroups=#!topic/linux.kernel/u6cKf4D1D-k">https://groups.google.com/forum/?fromgroups=#!topic/linux.kernel/u6cKf4D1D-k</a></p></li>
</ul>
</div></blockquote>
...
of <code class="docutils literal notranslate"><span class="pre">libpythonX.Y.so</span></code> it can be <code class="docutils literal notranslate"><span class="pre">libpythonX.Ym.so</span></code>.</p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Applications</span><span class="o">/</span><span class="n">Xcode</span><span class="o">.</span><span class="n">app</span><span class="o">/</span><span class="n">Contents</span><span class="o">/</span><span class="n">Developer</span><span class="o">/</span><span class="n">Toolchains</span>
</pre></div>
</div>
<p>and manually add symlinks to define the true location of the compiler tools.</p>
<ol class="arabic simple" start="5">
<li><p>Restore ability to compile mod_wsgi source code under Apache 1.3.</p></li>
</ol>
...
<code class="docutils literal notranslate"><span class="pre">--enable-framework</span></code> option. The existing <code class="docutils literal notranslate"><span class="pre">--disable-framework</span></code> has now
...
files when Apache <code class="docutils literal notranslate"><span class="pre">CoreDumpDirectory</span></code> directive used.</p>
...
by an unexpected signal.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-3.4.html" class="btn btn-neutral float-right" title="Version 3.4" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.0.html" class="btn btn-neutral float-left" title="Version 4.0" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
