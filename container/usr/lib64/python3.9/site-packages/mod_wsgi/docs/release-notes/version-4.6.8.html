...
<head>
  ...
  <title>Version 4.6.8 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.6.7" href="version-4.6.7.html" />
    <link rel="prev" title="Version 4.7.1" href="version-4.7.1.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.6.8</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.6.8.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-6-8">
<h1>Version 4.6.8<a class="headerlink" href="#version-4-6-8" title="Permalink to this headline">¶</a></h1>
<p>Version 4.6.8 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.8">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.8</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>When the queue timeout was triggered for requests sent to daemon mode
processes, the error response wasn’t being flushed out correctly resulting
in the connection still being held up to the time of the socket timeout.</p></li>
</ul>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>Add <code class="docutils literal notranslate"><span class="pre">--enable-sendfile</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. Should only be
used where the operating system kernel supports <code class="docutils literal notranslate"><span class="pre">sendfile()</span></code> for the
file system type where files are hosted.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.6.7.html" class="btn btn-neutral float-right" title="Version 4.6.7" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.7.1.html" class="btn btn-neutral float-left" title="Version 4.7.1" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
