...
<head>
  ...
  <title>Version 4.4.8 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.7" href="version-4.4.7.html" />
    <link rel="prev" title="Version 4.4.9" href="version-4.4.9.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.8</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.8.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-8">
<h1>Version 4.4.8<a class="headerlink" href="#version-4-4-8" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.8 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.8">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.8</a></p>
</div></blockquote>
...
<p>1. The eviction timeout was not being correctly applied when request timeout
...
the timeout may still have been delayed.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added the <code class="docutils literal notranslate"><span class="pre">--error-log-name</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow
the name of the file used for the error log, when being written to the log
directory, to be overridden.</p>
<p>2. Added the <code class="docutils literal notranslate"><span class="pre">--access-log-name</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow
the name of the file used for the access log, when being written to the log
directory, to be overridden.</p>
<p>3. Added the <code class="docutils literal notranslate"><span class="pre">--startup-log-name</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow
...
directory, to be overridden.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.7.html" class="btn btn-neutral float-right" title="Version 4.4.7" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.9.html" class="btn btn-neutral float-left" title="Version 4.4.9" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
