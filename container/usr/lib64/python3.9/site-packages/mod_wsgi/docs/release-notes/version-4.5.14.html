...
<head>
  ...
  <title>Version 4.5.14 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.13" href="version-4.5.13.html" />
    <link rel="prev" title="Version 4.5.15" href="version-4.5.15.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.14</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.5.14.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-14">
<h1>Version 4.5.14<a class="headerlink" href="#version-4-5-14" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.14 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.14">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.14</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>Using the <code class="docutils literal notranslate"><span class="pre">--url-alias</span></code> option to the <code class="docutils literal notranslate"><span class="pre">runmodwsgi</span></code> management
command when integrating <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> with Django could fail
...
was necessary to add items with same type else sorting would break.</p></li>
</ul>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>Added a <code class="docutils literal notranslate"><span class="pre">name</span></code> attribute to the log object used in place of
<code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> and <code class="docutils literal notranslate"><span class="pre">sys.stderr</span></code>, and which is also used for
<code class="docutils literal notranslate"><span class="pre">wsgi.errors</span></code> in the per request <code class="docutils literal notranslate"><span class="pre">environ</span></code> dictionary. This is
because although the <code class="docutils literal notranslate"><span class="pre">name</span></code> attribute is not required to exist, one can
find code out there that assumes it always does exist for file like
objects. Adding the attribute ensures that such code doesn’t fail.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.13.html" class="btn btn-neutral float-right" title="Version 4.5.13" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.15.html" class="btn btn-neutral float-left" title="Version 4.5.15" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
