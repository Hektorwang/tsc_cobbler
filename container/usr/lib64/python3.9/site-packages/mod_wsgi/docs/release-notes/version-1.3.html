...
<head>
  ...
  <title>Version 1.3 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 1.2" href="version-1.2.html" />
    <link rel="prev" title="Version 1.4" href="version-1.4.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-1.3.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 1.3 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-1.3.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-1.3.tar.gz</a></p>
</div></blockquote>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Fix bug whereby mod_wsgi daemon process could hang when a request with
...
than UNIX socket buffer size, without first consuming the request content.</p>
<p>There were two aspects to this problem, the first is that the above would
...
hanging.</p>
<p>Code now correctly ensures that Python GIL is released prior to going into
...
process can continue and break out of its hung state.</p>
<p>Although this can still result in request thread being in a hung state
...
investigated.</p>
<p>Note that this scenario shouldn’t ever eventuate for a correctly implemented
...
system.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-1.2.html" class="btn btn-neutral float-right" title="Version 1.2" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-1.4.html" class="btn btn-neutral float-left" title="Version 1.4" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
