...
<head>
  ...
  <title>Version 4.5.10 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.9" href="version-4.5.9.html" />
    <link rel="prev" title="Version 4.5.11" href="version-4.5.11.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.10</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.10</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.10.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-10">
<h1>Version 4.5.10<a class="headerlink" href="#version-4-5-10" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.10 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.10">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.10</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>In version 4.5.9, the version number 4.5.8 was being incorrectly reported
via <code class="docutils literal notranslate"><span class="pre">mod_wsgi.version</span></code> in the per request WSGI environ dictionary.</p></li>
<li><p>When using Anaconda Python on MacOS X, the Python shared library wasn’t
...
loaded module, such as in Apache. When using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> the
...
to add before the <code class="docutils literal notranslate"><span class="pre">LoadModule</span></code> line for <code class="docutils literal notranslate"><span class="pre">wsgi_module</span></code>, a <code class="docutils literal notranslate"><span class="pre">LoadFile</span></code>
directive which loads the Ananconda Python shared library by its full
path from where it is located in the Anaconda Python <code class="docutils literal notranslate"><span class="pre">lib</span></code> directory.</p></li>
<li><p>Startup timeout wasn’t being cancelled after succesful load of the WSGI
...
timeout the process would be wrongly restarted.</p></li>
<li><p>Fix parsing of <code class="docutils literal notranslate"><span class="pre">Content-Length</span></code> header returned in daemon mode so that
responses greater than 2GB in size could be returned.</p></li>
<li><p>Using incorrect header files in workaround to be able to compile mod_wsgi
on MacOSX Sierra when using <code class="docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span></code>. Was using old MacOS X 10.6
...
No choice until Apple fixes their broken Xcode and Apache installation.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.9.html" class="btn btn-neutral float-right" title="Version 4.5.9" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.11.html" class="btn btn-neutral float-left" title="Version 4.5.11" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
