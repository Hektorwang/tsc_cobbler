...
<head>
  ...
  <title>Version 4.3.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.3.1" href="version-4.3.1.html" />
    <link rel="prev" title="Version 4.4.0" href="version-4.4.0.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.3.2</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.3.2.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 4.3.2<a class="headerlink" href="#version-4-3-2" title="Permalink to this headline">¶</a></h1>
<p>Version 4.3.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.3.2">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.3.2</a></p>
</div></blockquote>
...
<p>1. Linux behaviour when using <code class="docutils literal notranslate"><span class="pre">connect()</span></code> on a non blocking UNIX socket
and the listener queue is full, is apparently not POSIX compliant and it
returns <code class="docutils literal notranslate"><span class="pre">EAGAIN</span></code> instead of <code class="docutils literal notranslate"><span class="pre">ECONNREFUSED</span></code>. The code handling errors
from the <code class="docutils literal notranslate"><span class="pre">connect()</span></code> wasn’t accomodating this non standard behaviour
and so would fail immediately rather than retrying.</p>
<p>2. Only change working directory for mod_wsgi daemon process after having
...
root access priviliges.</p>
<p>3. The workaround for getting pyvenv style virtual environments to work
...
Py_SetProgramName() call even if brew Python 2.7 doesn’t.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. If the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive or the <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option is
used with the <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive, the path provided, which is
...
path.</p>
<p>This is being done to warn when an invalid path has been supplied that
...
<code class="docutils literal notranslate"><span class="pre">python</span></code> on the users <code class="docutils literal notranslate"><span class="pre">PATH</span></code>. This may not be the Python installation
or virtual environment you intended be used.</p>
<p>2. The Apache configuration snippet generated as an example when running
the <code class="docutils literal notranslate"><span class="pre">install-module</span></code> sub command of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to install the
<code class="docutils literal notranslate"><span class="pre">mod_wsgi.so</span></code> into the Apache installation itself, will now output a
<code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive for the Python installation or virtual
environment the mod_wsgi module was compiled against so that the correct
Python runtime will be used.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.3.1.html" class="btn btn-neutral float-right" title="Version 4.3.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.0.html" class="btn btn-neutral float-left" title="Version 4.4.0" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
