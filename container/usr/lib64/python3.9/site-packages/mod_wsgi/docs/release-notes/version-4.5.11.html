...
<head>
  ...
  <title>Version 4.5.11 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.10" href="version-4.5.10.html" />
    <link rel="prev" title="Version 4.5.12" href="version-4.5.12.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.11</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.11</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.11.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-11">
<h1>Version 4.5.11<a class="headerlink" href="#version-4-5-11" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.11 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.11">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.11</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>The <code class="docutils literal notranslate"><span class="pre">runmodwsgi</span></code> option when using Django application integration would
fail on older Django versions up to Django 1.7.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.10.html" class="btn btn-neutral float-right" title="Version 4.5.10" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.12.html" class="btn btn-neutral float-left" title="Version 4.5.12" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
