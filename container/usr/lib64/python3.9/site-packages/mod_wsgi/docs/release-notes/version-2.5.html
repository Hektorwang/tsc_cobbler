...
<head>
  ...
  <title>Version 2.5 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 2.4" href="version-2.4.html" />
    <link rel="prev" title="Version 2.6" href="version-2.6.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 2.5</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-2.5.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 2.5<a class="headerlink" href="#version-2-5" title="Permalink to this headline">¶</a></h1>
<p>Version 2.5 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-2.5.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-2.5.tar.gz</a></p>
</div></blockquote>
...
<p>1. Change to workaround problem where correct version of Python framework
...
this results in framework then being picked up from the correct location.</p>
<p>This problem may well have only started cropping up at some point due to a
...
<p>2. Remove isatty from Log object used for stdout/stderr. It should have
...
not supply this, but the packages which were trying to use it.</p>
<p>For more details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=146">http://code.google.com/p/modwsgi/issues/detail?id=146</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-2.4.html" class="btn btn-neutral float-right" title="Version 2.4" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.6.html" class="btn btn-neutral float-left" title="Version 2.6" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
