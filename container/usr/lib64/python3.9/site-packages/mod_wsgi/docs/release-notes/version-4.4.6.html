...
<head>
  ...
  <title>Version 4.4.6 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.5" href="version-4.4.5.html" />
    <link rel="prev" title="Version 4.4.7" href="version-4.4.7.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.6</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.6.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-6">
<h1>Version 4.4.6<a class="headerlink" href="#version-4-4-6" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.6 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.6">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.6</a></p>
</div></blockquote>
...
<p>1. Apache 2.2.29 and 2.4.11 introduce additional fields to the request
structure <code class="docutils literal notranslate"><span class="pre">request_rec</span></code> due to CVE-2013-5704. The addition of these
...
members.</p>
<p>If you are upgrading your Apache installation to those versions or later
...
version.</p>
<p>In recompiling mod_wsgi 4.4.6 source code against the newer Apache versions
the source code is able to detect the new fields exist at compile time by
checking a compile time version number.</p>
<p>One problem that can arise is that where a CVE is raised for a security
...
Apache versions with the backport that the additional fields exist.</p>
<p>To combat this problem, mod_wsgi will do some runtime checks which look at
the actual size of <code class="docutils literal notranslate"><span class="pre">request_rec</span></code> and calculate whether the additional
fields have been added by way of a backported change. In this case mod_wsgi
will then set the fields as necessary.</p>
<p>As a final fail safe for forward compatibility. If the current mod_wsgi
source code is compiled against a version of Apache which doesn’t have the
CVE change applied, it will pad the <code class="docutils literal notranslate"><span class="pre">request_rec</span></code> and optimistically set
...
fields can be detected at compile time.</p>
<p>2. Override <code class="docutils literal notranslate"><span class="pre">LC_ALL</span></code> environment variable when <code class="docutils literal notranslate"><span class="pre">locale</span></code> option to the
<code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive. It is not always sufficient to just call
<code class="docutils literal notranslate"><span class="pre">setlocale()</span></code> as some Python code, including interpreter initialisation
can still consult the original <code class="docutils literal notranslate"><span class="pre">LC_ALL</span></code> environment variable. In this
case this can result in an undesired file system encoding still being
selected.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added <code class="docutils literal notranslate"><span class="pre">--enable-gdb</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> for when running
in debug mode. With this option set, Apache will be started up within
<code class="docutils literal notranslate"><span class="pre">gdb</span></code> allowing the debug of process crashes on startup or while handling
requests. If the <code class="docutils literal notranslate"><span class="pre">gdb</span></code> program is not in <code class="docutils literal notranslate"><span class="pre">PATH</span></code>, the <code class="docutils literal notranslate"><span class="pre">--gdb-executable</span></code>
option can be set to give its location.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.5.html" class="btn btn-neutral float-right" title="Version 4.4.5" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.7.html" class="btn btn-neutral float-left" title="Version 4.4.7" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
