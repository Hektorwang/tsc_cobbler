...
<head>
  ...
  <title>Version 4.4.21 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.20" href="version-4.4.20.html" />
    <link rel="prev" title="Version 4.4.22" href="version-4.4.22.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.21</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.21</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.21.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-21">
<h1>Version 4.4.21<a class="headerlink" href="#version-4-4-21" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.21 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.21">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.21</a></p>
</div></blockquote>
...
<p>1. When any of the options <code class="docutils literal notranslate"><span class="pre">--enable-debugger</span></code>, <code class="docutils literal notranslate"><span class="pre">--enable-debugger</span></code>,
<code class="docutils literal notranslate"><span class="pre">--enable-coverage</span></code>, <code class="docutils literal notranslate"><span class="pre">--enable-profiler</span></code>, <code class="docutils literal notranslate"><span class="pre">--enable-recorder</span></code> or
<code class="docutils literal notranslate"><span class="pre">--enable-gdb</span></code> are used, debug module will now automatically be enabled.
Previously you had to also supply the <code class="docutils literal notranslate"><span class="pre">--debug-mode</span></code> option otherwise
these options wouldn’t be honoured.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Add a WSGI test application to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> which returns back
...
by running:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">-</span><span class="n">express</span> <span class="n">start</span><span class="o">-</span><span class="n">server</span> <span class="o">--</span><span class="n">application</span><span class="o">-</span><span class="nb">type</span> <span class="n">module</span> <span class="n">mod_wsgi</span><span class="o">.</span><span class="n">server</span><span class="o">.</span><span class="n">environ</span>
</pre></div>
</div>
<p>2. Added <code class="docutils literal notranslate"><span class="pre">--entry-point</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> as more explicit
...
the purpose when you have a long list of options.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.20.html" class="btn btn-neutral float-right" title="Version 4.4.20" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.22.html" class="btn btn-neutral float-left" title="Version 4.4.22" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
