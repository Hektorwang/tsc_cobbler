...
<head>
  ...
  <title>Version 4.2.8 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.2.7" href="version-4.2.7.html" />
    <link rel="prev" title="Version 4.3.0" href="version-4.3.0.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.2.8</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.2.8.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-2-8">
<h1>Version 4.2.8<a class="headerlink" href="#version-4-2-8" title="Permalink to this headline">¶</a></h1>
<p>Version 4.2.8 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.8.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.8.tar.gz</a></p>
</div></blockquote>
...
<p>1. Disable feature for dumping stack traces on daemon process shutdown when
a timeout occurs when using Python prior to 2.5. This is because the C API
functions are not available in older Python versions.</p>
<p>2. If using Python 3.4 the minimum MacOS X version you can use is 10.8.
...
mod_wsgi daemon mode processes to crash at runtime.</p>
<p>3. Python 3.3+ pyvenv style virtual environments would not work with
mod_wsgi via the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive or the <code class="docutils literal notranslate"><span class="pre">home</span></code> option to the
<code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive. This is because the support in Python for
pyvenv will not work with embedded systems which set the equivalent of
<code class="docutils literal notranslate"><span class="pre">PYTHONHOME</span></code> via the Python C API.</p>
<p>The underlying problem in Python is described in issue:</p>
<blockquote>
<div><ul class="simple">
<li><p><a class="reference external" href="http://bugs.python.org/issue22213">http://bugs.python.org/issue22213</a></p></li>
</ul>
</div></blockquote>
<p>of the Python issue tracer.</p>
<p>To support both normal virtualenv style virtual environments and pyvenv
...
trick will work on Windows systems.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.2.7.html" class="btn btn-neutral float-right" title="Version 4.2.7" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.3.0.html" class="btn btn-neutral float-left" title="Version 4.3.0" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
