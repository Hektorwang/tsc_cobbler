...
<head>
  ...
  <title>Version 4.4.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.1" href="version-4.4.1.html" />
    <link rel="prev" title="Version 4.4.3" href="version-4.4.3.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.2</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.2.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-2">
<h1>Version 4.4.2<a class="headerlink" href="#version-4-4-2" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.2">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.2</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">--ssl-port</span></code> option has been deprecated in favour of the option
<code class="docutils literal notranslate"><span class="pre">--https-port</span></code>. Strictly speaking SSL no longer exists and has been
supplanted with TLS. The ‘S’ in ‘HTTPS’ is actually meant to mean secure
and not ‘SSL’. So change name of option to properly match terminoligy.</p>
<p>2. The name of the startup log was changed such that naming was consistent
with how logs are normally named with Apache. That is <code class="docutils literal notranslate"><span class="pre">startup_log</span></code>
instead of <code class="docutils literal notranslate"><span class="pre">startup.log</span></code>, thereby matching convention with <code class="docutils literal notranslate"><span class="pre">error_log</span></code>
and <code class="docutils literal notranslate"><span class="pre">access_log</span></code>.</p>
</div>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<p>1. When a default language was specified using the <code class="docutils literal notranslate"><span class="pre">locale</span></code> option to
the <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive or the <code class="docutils literal notranslate"><span class="pre">--locale</span></code> option to
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, if it did not actually match a locale supported by
the operating system, that the locale couldn’t be set wasn’t logged. Such
a message is now logged along with a suggestion to use <code class="docutils literal notranslate"><span class="pre">C.UTF-8</span></code> as a
fallback locale if the intent is to have <code class="docutils literal notranslate"><span class="pre">UTF-8</span></code> support.</p>
<p>2. When using the <code class="docutils literal notranslate"><span class="pre">--https-only</span></code> option with <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, a HTTP
request was not being redirected to be a HTTPS request when there were no
server aliases specified.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.1.html" class="btn btn-neutral float-right" title="Version 4.4.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.3.html" class="btn btn-neutral float-left" title="Version 4.4.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
