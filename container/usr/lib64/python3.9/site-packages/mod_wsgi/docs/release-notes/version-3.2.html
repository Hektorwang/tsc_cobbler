...
<head>
  ...
  <title>Version 3.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 3.1" href="version-3.1.html" />
    <link rel="prev" title="Version 3.3" href="version-3.3.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-3.2.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 3.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-3.2.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-3.2.tar.gz</a></p>
</div></blockquote>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. The path of the handler script was reported wrongly when
...
the URL mapped was reported instead.</p>
<p>2. Fix problem with use of condition variables/thread mutexes that was
causing all requests in daemon mode on a FreeBSD system to hang immediately
upon Apache being started.</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=176">http://code.google.com/p/modwsgi/issues/detail?id=176</a></p>
</div></blockquote>
<p>Also use a distinct flag with condition variable in case condition variable
...
and/or accept connections on that socket at the same time.</p>
<p>3. Wrong check of APR_HAS_THREADS by preprocessor conditional resulting in code
not compiling where APR_HAS_THREADS was defined but 0.</p>
<p>4. When Apache error logging redirected to syslog there is no error log
...
on startup by operating on null pointer. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=178">http://code.google.com/p/modwsgi/issues/detail?id=178</a></p>
</div></blockquote>
<p>5. Code was not compiling with Apache 2.3. This is because ap_accept_lock_mech
variable was removed. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=186">http://code.google.com/p/modwsgi/issues/detail?id=186</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-3.1.html" class="btn btn-neutral float-right" title="Version 3.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-3.3.html" class="btn btn-neutral float-left" title="Version 3.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
