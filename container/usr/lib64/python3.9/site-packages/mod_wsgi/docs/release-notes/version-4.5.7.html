...
<head>
  ...
  <title>Version 4.5.7 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.6" href="version-4.5.6.html" />
    <link rel="prev" title="Version 4.5.8" href="version-4.5.8.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.7</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.5.7.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-7">
<h1>Version 4.5.7<a class="headerlink" href="#version-4-5-7" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.7 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.7">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.7</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ol class="arabic simple">
<li><p>Resolved problem whereby mod_wsgi would fail on startup when using
Anaconda Python. This was caused by Anaconda Python changing the
behaviour of the C API function <code class="docutils literal notranslate"><span class="pre">Py_GetVersion()</span></code> so that it can no
...
avoids need to call <code class="docutils literal notranslate"><span class="pre">Py_GetVersion()</span></code>.</p></li>
</ol>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ol class="arabic simple">
<li><p>Add <code class="docutils literal notranslate"><span class="pre">--http2</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> for enabling support of
HTTP/2. Requires the <code class="docutils literal notranslate"><span class="pre">mod_http2</span></code> module to be compiled into Apache
httpd server for versions of Apache where that is available.</p></li>
</ol>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.6.html" class="btn btn-neutral float-right" title="Version 4.5.6" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.8.html" class="btn btn-neutral float-left" title="Version 4.5.8" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
