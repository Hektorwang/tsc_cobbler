...
<head>
  ...
  <title>Version 3.1 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 3.0" href="version-3.0.html" />
    <link rel="prev" title="Version 3.2" href="version-3.2.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-3.1.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 3.1 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-3.1.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-3.1.tar.gz</a></p>
</div></blockquote>
<p>As this version follows on quickly from mod_wsgi 3.0, ensure you read:</p>
<ul class="simple">
<li><p><a class="reference internal" href="version-3.0.html"><span class="doc">Version 3.0</span></a></p></li>
</ul>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Ensure that any compiler flags supplied via the CFLAGS environment variable
...
compiler options. For more details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=166">http://code.google.com/p/modwsgi/issues/detail?id=166</a></p>
</div></blockquote>
</div>
...
<p>1. Now give more explicit error message when compilation fails due to the
Apache or Python developer header files not being installed. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=169">http://code.google.com/p/modwsgi/issues/detail?id=169</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-3.0.html" class="btn btn-neutral float-right" title="Version 3.0" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-3.2.html" class="btn btn-neutral float-left" title="Version 3.2" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
