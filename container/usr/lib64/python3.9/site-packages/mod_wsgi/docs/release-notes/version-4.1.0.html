...
<head>
  ...
  <title>Version 4.1.0 &mdash; mod_wsgi 4.7.1 documentation</title>
...
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.1.0.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.1.0.tar.gz</a></p>
</div></blockquote>
...
<ul class="simple">
<li><p><a class="reference internal" href="version-3.2.html"><span class="doc">Version 3.2</span></a></p></li>
<li><p><a class="reference internal" href="version-3.3.html"><span class="doc">Version 3.3</span></a></p></li>
<li><p><a class="reference internal" href="version-3.4.html"><span class="doc">Version 3.4</span></a></p></li>
<li><p><a class="reference internal" href="version-3.5.html"><span class="doc">Version 3.5</span></a></p></li>
</ul>
...
the values of multiple <code class="docutils literal notranslate"><span class="pre">WWW-Authenticate</span></code> headers would be merged when
...
some type of <code class="docutils literal notranslate"><span class="pre">WWW-Authenticate</span></code> headers.</p>
</div>
...
<p>1. Use of kernel <code class="docutils literal notranslate"><span class="pre">sendfile()</span></code> function by <code class="docutils literal notranslate"><span class="pre">wsgi.file_wrapper</span></code> is now
...
either mode using <code class="docutils literal notranslate"><span class="pre">WSGIEnableSendfile</span></code> directive, setting it to <code class="docutils literal notranslate"><span class="pre">On</span></code> to
enable it.</p>
<p>The default is now off because kernel <code class="docutils literal notranslate"><span class="pre">sendfile()</span></code> is not always able to
work on all file objects. Some instances where it will not work are
described for the Apache <code class="docutils literal notranslate"><span class="pre">EnableSendfile</span></code> directive.</p>
<blockquote>
<div><p><a class="reference external" href="http://httpd.apache.org/docs/2.2/mod/core.html#enablesendfile">http://httpd.apache.org/docs/2.2/mod/core.html#enablesendfile</a></p>
</div></blockquote>
<p>Although Apache has use of <code class="docutils literal notranslate"><span class="pre">sendfile()</span></code> enabled by default for static
...
file objects which will work with <code class="docutils literal notranslate"><span class="pre">sendfile()</span></code>.</p>
<p>2. The <code class="docutils literal notranslate"><span class="pre">HTTPS</span></code> variable is no longer set within the WSGI environment. The
authoritative indicator of whether a SSL connection is used is
<code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code> and a WSGI compliant application should check for
<code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code>. The only reason that <code class="docutils literal notranslate"><span class="pre">HTTPS</span></code> was supplied at all was
because early Django versions supporting WSGI interface weren’t correctly
using <code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code>. Instead they were expecting to see <code class="docutils literal notranslate"><span class="pre">HTTPS</span></code> to
exist.</p>
...
<p>Note that you can still set <code class="docutils literal notranslate"><span class="pre">HTTPS</span></code> in Apache configuration using the
<code class="docutils literal notranslate"><span class="pre">SetEnv</span></code> or <code class="docutils literal notranslate"><span class="pre">SetEnvIf</span></code> directive, or via a rewrite rule. In that case,
that will override what <code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code> is set to and once
<code class="docutils literal notranslate"><span class="pre">wsgi.url_scheme</span></code> is set appropriately, the <code class="docutils literal notranslate"><span class="pre">HTTPS</span></code> variable will be
removed from the set of variables passed through to the WSGI environment.</p>
<p>3. The <code class="docutils literal notranslate"><span class="pre">wsgi.version</span></code> variable has been reverted to 1.0 to conform to the
...
<p>4. The <code class="docutils literal notranslate"><span class="pre">inactivity-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> now only
...
long running request. See the new <code class="docutils literal notranslate"><span class="pre">request-timeout</span></code> option for a way of
interrupting long running, potentially blocked requests and restarting
the process.</p>
<p>5. If the <code class="docutils literal notranslate"><span class="pre">home</span></code> option is used with <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>, in addition
...
<code class="docutils literal notranslate"><span class="pre">home</span></code> option for this to come into play.</p>
...
is specified by the <code class="docutils literal notranslate"><span class="pre">home</span></code> option. This again mirrors what the normal
Python command line interpreter does.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Add <code class="docutils literal notranslate"><span class="pre">supplementary-groups</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow
group membership to be overridden and specified comma separate list of
groups used instead.</p>
<p>2. Add a <code class="docutils literal notranslate"><span class="pre">graceful-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>. This option
is applied in a number of circumstances.</p>
<p>When <code class="docutils literal notranslate"><span class="pre">maximum-requests</span></code> and this option are used together, when maximum
...
<p>When <code class="docutils literal notranslate"><span class="pre">cpu-time-limit</span></code> and this option are used together, when CPU time
...
when sent a graceful restart signal. Signal is usually <code class="docutils literal notranslate"><span class="pre">SIGUSR1</span></code> but is
platform dependent as using same signal as Apache would use. If the
<code class="docutils literal notranslate"><span class="pre">graceful-timeout</span></code> option had been provided to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>,
...
<code class="docutils literal notranslate"><span class="pre">SIGTERM</span></code>.</p>
<p>4. Add <code class="docutils literal notranslate"><span class="pre">memory-limit</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow memory
usage of daemon processes to be restricted. This will have no affect on
some platforms as <code class="docutils literal notranslate"><span class="pre">RLIMIT_AS</span></code>/<code class="docutils literal notranslate"><span class="pre">RLIMIT_DATA</span></code> with <code class="docutils literal notranslate"><span class="pre">setrlimit()</span></code> isn’t
...
<p>5. Add <code class="docutils literal notranslate"><span class="pre">virtual-memory-limit</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow
virtual memory usage of daemon processes to be restricted. This will have
no affect on some platforms as <code class="docutils literal notranslate"><span class="pre">RLIMIT_VMEM</span></code> with <code class="docutils literal notranslate"><span class="pre">setrlimit()</span></code> isn’t
...
in the environ dictionary for <code class="docutils literal notranslate"><span class="pre">mod_ssl.is_https</span></code> and
<code class="docutils literal notranslate"><span class="pre">mod_ssl.var_lookup</span></code>. These equate to callable functions provided by
<code class="docutils literal notranslate"><span class="pre">mod_ssl</span></code> for determining if the client connection to Apache used SSL and
...
<p>7. For Python 2.6 and above, the <code class="docutils literal notranslate"><span class="pre">WSGIDontWriteBytecode</span></code> directive can be
...
code files. To disable writing of byte code files, set directive to <code class="docutils literal notranslate"><span class="pre">On</span></code>.</p>
...
remove <code class="docutils literal notranslate"><span class="pre">.pyc</span></code> files from web application directories if relying on this
option to ensure that <code class="docutils literal notranslate"><span class="pre">.py</span></code> file is always used.</p>
<p>8. Add <code class="docutils literal notranslate"><span class="pre">request-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow a
...
<p>9. Add <code class="docutils literal notranslate"><span class="pre">connect-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow a
...
<p>10. Add <code class="docutils literal notranslate"><span class="pre">socket-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow the
...
the Apache <code class="docutils literal notranslate"><span class="pre">Timeout</span></code> directive.</p>
<p>If this option is not specified, it will default to the value of the Apache
<code class="docutils literal notranslate"><span class="pre">Timeout</span></code> directive.</p>
<p>11. Add <code class="docutils literal notranslate"><span class="pre">queue-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow a
...
<p>12. Add <code class="docutils literal notranslate"><span class="pre">listen-backlog</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to allow the
...
<p>13. Add <code class="docutils literal notranslate"><span class="pre">WSGIPythonHashSeed</span></code> directive to allow Python behaviour related
to initial hash seed to be overridden when the interpreter supports it.</p>
<p>This is equivalent to setting the <code class="docutils literal notranslate"><span class="pre">PYTHONHASHSEED</span></code> environment variable
and should be set to either <code class="docutils literal notranslate"><span class="pre">random</span></code> or a number in the range in range
<code class="docutils literal notranslate"><span class="pre">[0;</span> <span class="pre">4294967295]</span></code>.</p>
...
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> script that can then be used to start up
...
<p>Once the <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code> package has been installed into your Python
installation, you can run:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">-</span><span class="n">express</span> <span class="n">start</span><span class="o">-</span><span class="n">server</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">-</span><span class="n">express</span> <span class="n">start</span><span class="o">-</span><span class="n">server</span> <span class="n">wsgi</span><span class="o">.</span><span class="n">py</span>
</pre></div>
</div>
<p>For options run:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">-</span><span class="n">express</span> <span class="n">start</span><span class="o">-</span><span class="n">server</span> <span class="o">--</span><span class="n">help</span>
</pre></div>
</div>
<p>If you already have another web server running on port 8000, you can
override the port to be used using the <code class="docutils literal notranslate"><span class="pre">--port</span></code> option:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">-</span><span class="n">express</span> <span class="n">start</span><span class="o">-</span><span class="n">server</span> <span class="n">wsgi</span><span class="o">.</span><span class="n">py</span> <span class="o">--</span><span class="n">port</span> <span class="mi">8001</span>
</pre></div>
</div>
<p>15. Implemented a Django application plugin to add a <code class="docutils literal notranslate"><span class="pre">runmodwsgi</span></code> command
...
<p>To enable, once the <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code> package has been installed into your
Python installation, add <code class="docutils literal notranslate"><span class="pre">mod_wsgi.server</span></code> to the <code class="docutils literal notranslate"><span class="pre">INSTALLED_APPS</span></code>
setting in your Django settings file.</p>
<p>After having run the <code class="docutils literal notranslate"><span class="pre">collectstatic</span></code> Django management command, you
can then run:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">python</span> <span class="n">manage</span><span class="o">.</span><span class="n">py</span> <span class="n">runmodwsgi</span>
</pre></div>
</div>
<p>For options run:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">python</span> <span class="n">manage</span><span class="o">.</span><span class="n">py</span> <span class="n">runmodwsgi</span> <span class="o">--</span><span class="n">help</span>
</pre></div>
</div>
...
The name of the option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to set the buffer size used
is <code class="docutils literal notranslate"><span class="pre">header-buffer-size</span></code>.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.0.html" class="btn btn-neutral float-right" title="Version 4.0" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.1.1.html" class="btn btn-neutral float-left" title="Version 4.1.1" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
