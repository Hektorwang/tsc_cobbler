...
<head>
  ...
  <title>Version 4.5.21 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.20" href="version-4.5.20.html" />
    <link rel="prev" title="Version 4.5.22" href="version-4.5.22.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.21</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.21</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.21.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-21">
<h1>Version 4.5.21<a class="headerlink" href="#version-4-5-21" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.21 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.21">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.21</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul>
<li><p>Installation using <code class="docutils literal notranslate"><span class="pre">pip</span></code> or <code class="docutils literal notranslate"><span class="pre">setup.py</span></code> install was failing on
MacOS X High Sierra with latest Xcode as Apple doesn’t even include
the <code class="docutils literal notranslate"><span class="pre">apxs</span></code> program at all.</p>
<p>Note you still cannot use the configure/make/make install method of
deploying mod_wsgi to MacOS X. You need to use the <code class="docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span></code>
method.</p>
</li>
<li><p>Speculated that crashes on daemon process shutdown were being caused
...
Python interpreter deadlock detection thread.</p></li>
</ul>
</div>
...
<ul>
<li><p>Set <code class="docutils literal notranslate"><span class="pre">wsgi.input_terminated</span></code> to <code class="docutils literal notranslate"><span class="pre">True</span></code> in WSGI environment. This is a
...
end of input and that <code class="docutils literal notranslate"><span class="pre">CONTENT_LENGTH</span></code> can be ignored. This is to be
...
<code class="docutils literal notranslate"><span class="pre">CONTENT_LENGTH</span></code>, such as occurs when request content is compressed
and is decompressed by the Apache web server.</p>
<p>The ability to safely read until end of input was always present in
...
specification.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.20.html" class="btn btn-neutral float-right" title="Version 4.5.20" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.22.html" class="btn btn-neutral float-left" title="Version 4.5.22" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
