...
<head>
  ...
  <title>Version 4.1.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.1.1" href="version-4.1.1.html" />
    <link rel="prev" title="Version 4.1.3" href="version-4.1.3.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.1.2</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.1.2.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-1-2">
<h1>Version 4.1.2<a class="headerlink" href="#version-4-1-2" title="Permalink to this headline">¶</a></h1>
<p>Version 4.1.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.1.2.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.1.2.tar.gz</a></p>
</div></blockquote>
...
<p>1. The integration for Django management command was looking for the wrong
name for the admin script to start mod_wsgi express.</p>
<p>2. The code which connected to the mod_wsgi daemon process was passing an
incorrect size into the connect() call for the size of the address
structure. On some Linux systems this would cause an error similar to:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">(</span><span class="mi">22</span><span class="p">)</span><span class="n">Invalid</span> <span class="n">argument</span><span class="p">:</span> <span class="n">mod_wsgi</span> <span class="p">(</span><span class="n">pid</span><span class="o">=</span><span class="mi">22944</span><span class="p">):</span> <span class="n">Unable</span> <span class="n">to</span> <span class="n">connect</span> <span class="n">to</span> \
    <span class="n">WSGI</span> <span class="n">daemon</span> <span class="n">process</span> <span class="s1">&#39;localhost:8000&#39;</span> <span class="n">on</span> \
    <span class="s1">&#39;/tmp/mod_wsgi-localhost:8000:12145/wsgi.22942.0.1.sock&#39;</span>
</pre></div>
</div>
<p>This issue was only introduced in 4.1.0 and does not affect older versions.</p>
<p>3. The deadlock detection thread could try and acquire the Python GIL
...
acquire the Python GIL.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.1.1.html" class="btn btn-neutral float-right" title="Version 4.1.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.1.3.html" class="btn btn-neutral float-left" title="Version 4.1.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
