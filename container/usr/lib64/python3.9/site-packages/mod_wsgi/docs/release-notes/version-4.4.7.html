...
<head>
  ...
  <title>Version 4.4.7 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.6" href="version-4.4.6.html" />
    <link rel="prev" title="Version 4.4.8" href="version-4.4.8.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.7</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.7.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-7">
<h1>Version 4.4.7<a class="headerlink" href="#version-4-4-7" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.7 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.7">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.7</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">proxy-buffer-size</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive
was renamed to <code class="docutils literal notranslate"><span class="pre">response-buffer-size</span></code> to avoid confusion with options
related to normal HTTP proxying. The <code class="docutils literal notranslate"><span class="pre">--proxy-buffer-size</span></code> option of
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> was similarly renamed to <code class="docutils literal notranslate"><span class="pre">--response-buffer-size</span></code>.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added <code class="docutils literal notranslate"><span class="pre">--service-script</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to allow a
...
for starting the service.</p>
<p>If <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> is being run as root, then a user and group can be
specified for the service using the <code class="docutils literal notranslate"><span class="pre">--service-user</span></code> and
<code class="docutils literal notranslate"><span class="pre">--service-group</span></code> options. The options take two arguments, a short name
for the service and the user or group name respectively.</p>
<p>2. Added <code class="docutils literal notranslate"><span class="pre">--proxy-url-alias</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> for setting
up proxying of a sub URL of the site to a remote URL.</p>
<p>3. Added <code class="docutils literal notranslate"><span class="pre">--proxy-virtual-host</span></code> option to <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> for setting
up proxying of a whole virtual host to a remote URL. Only supports proxying
of HTTP requests and not HTTPS requests.</p>
<p>4. Added <code class="docutils literal notranslate"><span class="pre">eviction-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive.
For the case where the graceful restart signal, usually <code class="docutils literal notranslate"><span class="pre">SIGUSR1</span></code>, is
...
requests and shuts down.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">graceful-timeout</span></code> option previously performed this exact role in
...
The existing <code class="docutils literal notranslate"><span class="pre">graceful-timeout</span></code> option is still used when a maximum
requests option or CPU usage limit is set. For backwards compatibility,
if <code class="docutils literal notranslate"><span class="pre">eviction-timeout</span></code> isn’t set, it will fall back to using any value
specified using the <code class="docutils literal notranslate"><span class="pre">graceful-timeout</span></code> option.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">--eviction-timeout</span></code> option has also been added to
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> and behaves in a similar fashion.</p>
<p>5. Added support for new <code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code> package. The <code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code>
...
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code> package is installed before installing this package,
then the Apache httpd server installation installed by <code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code>
will be used instead of any system installed version of the Apache httpd
server when running <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. This allows you to workaround
any inability to upgrade the main Apache installation, or install its ‘dev’
package if missing, or install it outright if not present.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.6.html" class="btn btn-neutral float-right" title="Version 4.4.6" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.8.html" class="btn btn-neutral float-left" title="Version 4.4.8" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
