...
<head>
  ...
  <title>Version 3.3 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 3.2" href="version-3.2.html" />
    <link rel="prev" title="Version 3.4" href="version-3.4.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-3.3.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 3.3 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-3.3.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-3.3.tar.gz</a></p>
</div></blockquote>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Inactivity timeout not triggered at correct time when occurs for first
request after process is started. See</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=182">http://code.google.com/p/modwsgi/issues/detail?id=182</a></p>
</div></blockquote>
<p>2. Back off timer for failed connections to daemon process group wasn’t
working correctly and no delay on reconnect attempts was being applied. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=195">http://code.google.com/p/modwsgi/issues/detail?id=195</a></p>
</div></blockquote>
<p>3. Logging not appearing in Apache error log files when using daemon mode
and have multiple virtual hosts against same server name. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=204">http://code.google.com/p/modwsgi/issues/detail?id=204</a></p>
</div></blockquote>
<p>4. Eliminate logging of !KeyError exception in threading module when processes
are shutdown when using Python 2.6.5 or 3.1.2 or later. This wasn’t indicating
any real problem but was annoying all the same. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=197">http://code.google.com/p/modwsgi/issues/detail?id=197</a></p>
</div></blockquote>
<p>5. Fix potential for crash when logging error message resulting from failed
group authorisation.</p>
<ol class="arabic simple" start="6">
<li><p>Fix compilation problems with Apache 2.3.6.</p></li>
</ol>
</div>
...
<p>1. When compiled against ITK MPM for Apache, if using daemon mode, the
...
as script. See issue:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=187">http://code.google.com/p/modwsgi/issues/detail?id=187</a></p>
</div></blockquote>
<p>2. Add isatty() to log objects used for sys.stdout/sys.stderr and
...
return False to be safe.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-3.2.html" class="btn btn-neutral float-right" title="Version 3.2" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-3.4.html" class="btn btn-neutral float-left" title="Version 3.4" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
