...
<head>
  ...
  <title>Version 4.4.19 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.18" href="version-4.4.18.html" />
    <link rel="prev" title="Version 4.4.20" href="version-4.4.20.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.19</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.19</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.19.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-19">
<h1>Version 4.4.19<a class="headerlink" href="#version-4-4-19" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.19 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.19">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.19</a></p>
</div></blockquote>
...
<p>1. Daemon mode processes were crashing when attempting to set <code class="docutils literal notranslate"><span class="pre">USER</span></code>,
<code class="docutils literal notranslate"><span class="pre">USERNAME</span></code>, <code class="docutils literal notranslate"><span class="pre">LOGNAME</span></code> or <code class="docutils literal notranslate"><span class="pre">HOME</span></code> when no password entry could be
found for the current user ID. Now do not attempt to set these if the
user ID doesn’t have a password file entry.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.18.html" class="btn btn-neutral float-right" title="Version 4.4.18" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.20.html" class="btn btn-neutral float-left" title="Version 4.4.20" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
