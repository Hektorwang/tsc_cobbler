...
<head>
  ...
  <title>Version 1.1 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 1.0" href="version-1.0.html" />
    <link rel="prev" title="Version 1.2" href="version-1.2.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-1.1.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 1.1 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-1.1.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-1.1.tar.gz</a></p>
</div></blockquote>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Fix bug which could result in processes crashing when multiple threads
attempt to write to sys.stderr or sys.stdout at the same time. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=30">http://code.google.com/p/modwsgi/issues/detail?id=30</a></p>
</div></blockquote>
<p>Chance of this occuring was small, as was contingent on code writing out
strings which contained an embedded newline but no terminating new line,
thereby triggering the internal line caching code.</p>
<p>2. In error case when not able to release interpreter, was wrongly trying
...
do this even in case where had the Python GIL.</p>
<p>This problem would only have been encountered in situation where Python had
failed in a major way to begin with.</p>
<p>3. Incorrectly trying to output Python exception details when Python GIL
would not have been held.</p>
<p>This problem would only have been encountered in situation where Python had
failed in a major way to begin with.</p>
<p>4. Fix location of Python object reference count decrements to avoid
decrement reference count on null pointer.</p>
<p>Would only have caused a problem if Python was in some sort of corrupted
state to begin with as the object which the reference count was being
performed on should always exist.</p>
<p>5. Replace normal Apache connection setup in daemon processes with
...
to Apache as HTTPS requests could cause daemon processes to crash. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=33">http://code.google.com/p/modwsgi/issues/detail?id=33</a></p>
</div></blockquote>
<p>This was only occuring for some HTTPS configurations, but not known what
exactly was different about those configurations to cause the problem.
Actually possible that the real problem was mod_logio as described below.</p>
<p>6. Substitute optional ap_logio_add_bytes_out() function provided by the
...
triggering a crash due to configuration for mod_logio not being setup. See:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=34">http://code.google.com/p/modwsgi/issues/detail?id=34</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-1.0.html" class="btn btn-neutral float-right" title="Version 1.0" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-1.2.html" class="btn btn-neutral float-left" title="Version 1.2" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
