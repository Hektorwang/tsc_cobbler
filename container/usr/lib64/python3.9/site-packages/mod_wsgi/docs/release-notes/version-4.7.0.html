...
<head>
  ...
  <title>Version 4.7.0 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.7.1" href="version-4.7.1.html" />
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.7.0</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.7.0.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 4.7.0<a class="headerlink" href="#version-4-7-0" title="Permalink to this headline">¶</a></h1>
<p>Version 4.7.0 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.7.0">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.7.0</a></p>
</div></blockquote>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul>
<li><p>Now releasing parallel <code class="docutils literal notranslate"><span class="pre">mod_wsgi-standalone</span></code> package to PyPi. This is
the same as the <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code> package, except that by installing the
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-standalone</span></code> package, it will automatically trigger the
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code> package to install the Apache HTTPD server as part
of your Python installation. When you run <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> it will
use that Apache HTTPD server installation.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">mod_wsgi-standalone</span></code> package is required where you need to install
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> using its own Apache HTTPD installation due to no
system Apache HTTPD server package being available, and the installation
needs to be done using a <code class="docutils literal notranslate"><span class="pre">requirements.txt</span></code> file for <code class="docutils literal notranslate"><span class="pre">pip</span></code> or other
package install manager. Using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-standalone</span></code> will ensure
that the <code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code> package is installed first before attempting
to build and install mod_wsgi. This guarantee is not provided by <code class="docutils literal notranslate"><span class="pre">pip</span></code>
if you list <code class="docutils literal notranslate"><span class="pre">mod_wsgi-httpd</span></code> and <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code> packages as two entries.</p>
<p>The version numbering of the <code class="docutils literal notranslate"><span class="pre">mod_wsgi-standalone</span></code> package will follow
the <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code> versioning.</p>
</li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.7.1.html" class="btn btn-neutral float-right" title="Version 4.7.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
