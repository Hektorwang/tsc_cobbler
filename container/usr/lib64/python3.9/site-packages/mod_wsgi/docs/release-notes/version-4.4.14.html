...
<head>
  ...
  <title>Version 4.4.14 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.13" href="version-4.4.13.html" />
    <link rel="prev" title="Version 4.4.15" href="version-4.4.15.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.14</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.14</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.14.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-14">
<h1>Version 4.4.14<a class="headerlink" href="#version-4-4-14" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.14 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.14">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.14</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">--compress-responses</span></code> option of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> was
failing when Apache 2.4 was used. This was because <code class="docutils literal notranslate"><span class="pre">mod_filter</span></code> module
is required when using Apache 2.4 and it wasn’t being loaded.</p>
<p>2. On Python 3, the IO object wrapped by <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> and <code class="docutils literal notranslate"><span class="pre">sys.stderr</span></code>,
according to the Python documentation, must provide a <code class="docutils literal notranslate"><span class="pre">fileno()</span></code> method
even though no file descriptor exists corresponding to the Apache error
logs. The method should raise <code class="docutils literal notranslate"><span class="pre">IOError</span></code> if called to indicate not file
descriptor can be returned.</p>
<p>Previously, an attempt to use <code class="docutils literal notranslate"><span class="pre">fileno()</span></code> on <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> and <code class="docutils literal notranslate"><span class="pre">sys.stderr</span></code>
would raise an <code class="docutils literal notranslate"><span class="pre">AttributeError</span></code> instead due to there being no <code class="docutils literal notranslate"><span class="pre">fileno()</span></code>
method.</p>
<p>3. Use compiler include flags from running of <code class="docutils literal notranslate"><span class="pre">apr-config</span></code> and
<code class="docutils literal notranslate"><span class="pre">apu-config</span></code> when doing <code class="docutils literal notranslate"><span class="pre">pip</span></code> install of <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>. This is
necessary as on MacOS X 10.11 El Capitan the include flags for APR returned
by <code class="docutils literal notranslate"><span class="pre">apxs</span></code> refer to the wrong location causing installation to fail.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. When proxying a URL path or a virtual host, now setting request
header for <code class="docutils literal notranslate"><span class="pre">X-Forwarded-Port</span></code> so back end knows correct port that
front end used.</p>
<p>2. When proxying a URL path, if the request came in over a secure HTTP
connection, now setting request header for <code class="docutils literal notranslate"><span class="pre">X-Forwarded-Scheme</span></code> so back
end knows that front end handled the request over a secure connection.
The value of the header will be <code class="docutils literal notranslate"><span class="pre">https</span></code>.</p>
<p>3. When using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>, it is now possible to supply the
<code class="docutils literal notranslate"><span class="pre">--with-cgi</span></code> option, with any files in the document root directory with
a ‘.cgi’ extension then being processed as traditional CGI scripts.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.13.html" class="btn btn-neutral float-right" title="Version 4.4.13" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.15.html" class="btn btn-neutral float-left" title="Version 4.4.15" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
