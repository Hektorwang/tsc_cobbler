...
<head>
  ...
  <title>Version 4.2.4 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.2.3" href="version-4.2.3.html" />
    <link rel="prev" title="Version 4.2.5" href="version-4.2.5.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.2.4</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.2.4.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-2-4">
<h1>Version 4.2.4<a class="headerlink" href="#version-4-2-4" title="Permalink to this headline">¶</a></h1>
<p>Version 4.2.4 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.4.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.4.tar.gz</a></p>
</div></blockquote>
...
<p>1. Fixed one off error in applying limit to the number of supplementary
...
<code class="docutils literal notranslate"><span class="pre">supplementary-groups</span></code>, then memory corruption or a process crash could
occur.</p>
<p>2. Improved error handling in setting up the current working directory and
...
directory or group access rights.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Added the <code class="docutils literal notranslate"><span class="pre">--setup-only</span></code> option to mod_wsgi express so that it is
possible to create the configuration when using the Django management command
<code class="docutils literal notranslate"><span class="pre">runmodwsgi</span></code> without actually starting the server.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.2.3.html" class="btn btn-neutral float-right" title="Version 4.2.3" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.2.5.html" class="btn btn-neutral float-left" title="Version 4.2.5" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
