...
<head>
  ...
  <title>Version 4.5.13 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.5.12" href="version-4.5.12.html" />
    <link rel="prev" title="Version 4.5.14" href="version-4.5.14.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.5.13</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.5.13</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.5.13.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-5-13">
<h1>Version 4.5.13<a class="headerlink" href="#version-4-5-13" title="Permalink to this headline">¶</a></h1>
<p>Version 4.5.13 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.13">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.5.13</a></p>
</div></blockquote>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul>
<li><p>Added <code class="docutils literal notranslate"><span class="pre">response-socket-timeout</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>
...
of the Apache <code class="docutils literal notranslate"><span class="pre">Timeout</span></code> directive. With this change the timeout will be
based on <code class="docutils literal notranslate"><span class="pre">response-socket-timeout</span></code> option. If that is not set it will
use the the general <code class="docutils literal notranslate"><span class="pre">socket-timeout</span></code> option and if that isn’t set only
then will the value of the Apache <code class="docutils literal notranslate"><span class="pre">Timeout</span></code> directive be used.</p>
<p>The overall purpose of being able to separately control this option is to
...
the Apache <code class="docutils literal notranslate"><span class="pre">Timeout</span></code> directive, at 300 seconds meant it could take a
...
block if this occurred for many requests at the same time.</p>
<p>When using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> the option can be set using the command
line <code class="docutils literal notranslate"><span class="pre">--response-socket-timeout</span></code> option. If using <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>
the default socket timeout is 60 seconds so the issue would not have had
as big an impact, especially since <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> also defines a
...
the response.</p>
<p>An additional error message is also now logged to indicate that failure
...
client.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.5.12.html" class="btn btn-neutral float-right" title="Version 4.5.12" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.5.14.html" class="btn btn-neutral float-left" title="Version 4.5.14" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
