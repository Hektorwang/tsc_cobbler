...
<head>
  ...
  <title>Version 4.2.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.2.1" href="version-4.2.1.html" />
    <link rel="prev" title="Version 4.2.3" href="version-4.2.3.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.2.2</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.2.2.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 4.2.2<a class="headerlink" href="#version-4-2-2" title="Permalink to this headline">¶</a></h1>
<p>Version 4.2.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.2.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.2.2.tar.gz</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">envvars</span></code> file was being overwritten even if it existed and had
been modified.</p>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<p>1. Output the location of the <code class="docutils literal notranslate"><span class="pre">envvars</span></code> file when using the
<code class="docutils literal notranslate"><span class="pre">setup-server</span></code> command for <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> or if using the
<code class="docutils literal notranslate"><span class="pre">start-server</span></code> command and the <code class="docutils literal notranslate"><span class="pre">--envars-script</span></code> option was being used.</p>
<p>2. Output the location of the <code class="docutils literal notranslate"><span class="pre">apachectl</span></code> script when using the
<code class="docutils literal notranslate"><span class="pre">setup-server</span></code> command for <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code>.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.2.1.html" class="btn btn-neutral float-right" title="Version 4.2.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.2.3.html" class="btn btn-neutral float-left" title="Version 4.2.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
