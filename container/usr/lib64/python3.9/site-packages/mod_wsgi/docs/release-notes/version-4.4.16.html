...
<head>
  ...
  <title>Version 4.4.16 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.15" href="version-4.4.15.html" />
    <link rel="prev" title="Version 4.4.17" href="version-4.4.17.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.16</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Version 4.4.16</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/release-notes/version-4.4.16.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-16">
<h1>Version 4.4.16<a class="headerlink" href="#version-4-4-16" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.16 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.16">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.16</a></p>
</div></blockquote>
...
<p>1. If <code class="docutils literal notranslate"><span class="pre">/dev/stderr</span></code> cannot be opened for writing when startup log is
requested and logging to the terminal, then <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> would
fail. Now attempt fallback to using <code class="docutils literal notranslate"><span class="pre">/dev/tty</span></code> and if that cannot be
opened either, then give up on trying to use terminal for startup log.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.15.html" class="btn btn-neutral float-right" title="Version 4.4.15" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.17.html" class="btn btn-neutral float-left" title="Version 4.4.17" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
