...
<head>
  ...
  <title>Version 2.2 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 2.1" href="version-2.1.html" />
    <link rel="prev" title="Version 2.3" href="version-2.3.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 2.2</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-2.2.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 2.2<a class="headerlink" href="#version-2-2" title="Permalink to this headline">¶</a></h1>
<p>Version 2.2 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-2.2.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-2.2.tar.gz</a></p>
</div></blockquote>
<p><strong>Note: This version was quickly superseded by version 2.3 of mod_wsgi.
Version 2.2 should not be used.</strong></p>
...
<p>1. Use official way of setting process names on FreeBSD, NetBSD and OpenBSD.
For details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=90">http://code.google.com/p/modwsgi/issues/detail?id=90</a></p>
</div></blockquote>
<p>This is a backport of change from version 3.0 of mod_wsgi.</p>
</div>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. Fix bug whereby if mod_python is loaded at same time as mod_wsgi the
WSGIImportScript directive can cause Apache child processes to crash.
For details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=91">http://code.google.com/p/modwsgi/issues/detail?id=91</a></p>
</div></blockquote>
<p>2. Fix bug where mod_wsgi daemon process startup could fail due to old stale
UNIX listener socket file as described in:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=77">http://code.google.com/p/modwsgi/issues/detail?id=77</a></p>
</div></blockquote>
<p>3. Fix bug where listener socket file descriptors for daemon processes were
...
restart and graceful shutdown. For details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=95">http://code.google.com/p/modwsgi/issues/detail?id=95</a></p>
</div></blockquote>
<p>4. Fix bug where response was truncated when a null character appeared as
...
object, rather than optimised method such as sendfile().</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=100">http://code.google.com/p/modwsgi/issues/detail?id=100</a></p>
</div></blockquote>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-2.1.html" class="btn btn-neutral float-right" title="Version 2.1" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.3.html" class="btn btn-neutral float-left" title="Version 2.3" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
