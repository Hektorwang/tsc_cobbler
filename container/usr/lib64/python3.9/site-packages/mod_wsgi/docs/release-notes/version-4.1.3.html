...
<head>
  ...
  <title>Version 4.1.3 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.1.2" href="version-4.1.2.html" />
    <link rel="prev" title="Version 4.2.0" href="version-4.2.0.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.1.3</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.1.3.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-1-3">
<h1>Version 4.1.3<a class="headerlink" href="#version-4-1-3" title="Permalink to this headline">¶</a></h1>
<p>Version 4.1.3 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/archive/4.1.3.tar.gz">https://github.com/GrahamDumpleton/mod_wsgi/archive/4.1.3.tar.gz</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">setup.py</span></code> file wasn’t always detecting the Python library version
suffix properly when setting it up to be linked into the resulting
<code class="docutils literal notranslate"><span class="pre">mod_wsgi.so</span></code>. This would cause an error message at link time of:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="nb">bin</span><span class="o">/</span><span class="n">ld</span><span class="p">:</span> <span class="n">cannot</span> <span class="n">find</span> <span class="o">-</span><span class="n">lpython</span>
</pre></div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.1.2.html" class="btn btn-neutral float-right" title="Version 4.1.2" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.2.0.html" class="btn btn-neutral float-left" title="Version 4.2.0" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
