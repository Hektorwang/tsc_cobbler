...
<head>
  ...
  <title>Version 2.3 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 2.2" href="version-2.2.html" />
    <link rel="prev" title="Version 2.4" href="version-2.4.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 2.3</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-2.3.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Version 2.3<a class="headerlink" href="#version-2-3" title="Permalink to this headline">¶</a></h1>
<p>Version 2.3 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-2.3.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-2.3.tar.gz</a></p>
</div></blockquote>
<p><strong>Note that this is a quick followup to version 2.2 of mod_wsgi to rectify
...
<p>1. Fixed problem introduced in version 2.2 of mod_wsgi whereby use of
daemon mode would cause CGI scripts to fail.</p>
<p>It is quite possible that the bug could also have caused failures with other
Apache modules that relied on registering of cleanup functions against
Apache configuration memory pool.</p>
<p>For details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://groups.google.com/group/modwsgi/browse_frm/thread/79a86f8faffe7dcf">http://groups.google.com/group/modwsgi/browse_frm/thread/79a86f8faffe7dcf</a></p>
</div></blockquote>
<p>2. When using setproctitle() on BSD systems, first argument should be a
...
process to crash as corresponding arguments wouldn’t have ben provided.</p>
<p>For details see:</p>
<blockquote>
<div><p><a class="reference external" href="http://code.google.com/p/modwsgi/issues/detail?id=90">http://code.google.com/p/modwsgi/issues/detail?id=90</a></p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-2.2.html" class="btn btn-neutral float-right" title="Version 2.2" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-2.4.html" class="btn btn-neutral float-left" title="Version 2.4" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
