...
<head>
  ...
  <title>Version 1.4 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 1.3" href="version-1.3.html" />
    <link rel="prev" title="Version 1.5" href="version-1.5.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-1.4.rst.txt" rel="nofollow"> View page source</a>
...
<p>Version 1.4 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="http://modwsgi.googlecode.com/files/mod_wsgi-1.4.tar.gz">http://modwsgi.googlecode.com/files/mod_wsgi-1.4.tar.gz</a></p>
</div></blockquote>
<div class="section" id="bug-fixes">
<h2>Bug Fixes<a class="headerlink" href="#bug-fixes" title="Permalink to this headline">¶</a></h2>
<p>1. A negative value for content length in response wasn’t being rejected.
Where invalid header was being returned in response original response
status was being returned instead of a 500 error.</p>
<p>2. Fix bug which was resulting in logging destined for !VirtualHost !ErrorLog
...
<p>1. Optimise sending of WSGI environment across to daemon process by
...
<p>This is a backport of change from version 2.0 of mod_wsgi.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-1.3.html" class="btn btn-neutral float-right" title="Version 1.3" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-1.5.html" class="btn btn-neutral float-left" title="Version 1.5" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
