...
<head>
  ...
  <title>Version 4.6.6 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.6.5" href="version-4.6.5.html" />
    <link rel="prev" title="Version 4.6.7" href="version-4.6.7.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.6.6</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.6.6.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-6-6">
<h1>Version 4.6.6<a class="headerlink" href="#version-4-6-6" title="Permalink to this headline">¶</a></h1>
<p>Version 4.6.6 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.6">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.6.6</a></p>
</div></blockquote>
<div class="section" id="bugs-fixed">
<h2>Bugs Fixed<a class="headerlink" href="#bugs-fixed" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>Fix compilation failures when using Python 3.8.</p></li>
</ul>
</div>
...
<ul class="simple">
<li><p>When running <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> it will do a search for the location of
<code class="docutils literal notranslate"><span class="pre">bash</span></code> and <code class="docutils literal notranslate"><span class="pre">sh</span></code> when defining the shell to use for the generated
<code class="docutils literal notranslate"><span class="pre">apachectl</span></code>. The shell used can be overridden using <code class="docutils literal notranslate"><span class="pre">--shell-executable</span></code>
option. This is to get around issue with FreeBSD not having <code class="docutils literal notranslate"><span class="pre">/bin/bash</span></code>.</p></li>
</ul>
</div>
<div class="section" id="new-features">
<h2>New Features<a class="headerlink" href="#new-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
<li><p>The Apache request ID is accessible in request events as <code class="docutils literal notranslate"><span class="pre">request_id</span></code>.</p></li>
<li><p>The per request data dictionary accessible using <code class="docutils literal notranslate"><span class="pre">mod_wsgi.request_data()</span></code>
is now also accessible in events as <code class="docutils literal notranslate"><span class="pre">request_data</span></code>.</p></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.6.5.html" class="btn btn-neutral float-right" title="Version 4.6.5" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.6.7.html" class="btn btn-neutral float-left" title="Version 4.6.7" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
