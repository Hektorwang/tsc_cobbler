...
<head>
  ...
  <title>Version 4.4.4 &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Version 4.4.3" href="version-4.4.3.html" />
    <link rel="prev" title="Version 4.4.5" href="version-4.4.5.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.4.4</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/release-notes/version-4.4.4.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="version-4-4-4">
<h1>Version 4.4.4<a class="headerlink" href="#version-4-4-4" title="Permalink to this headline">¶</a></h1>
<p>Version 4.4.4 of mod_wsgi can be obtained from:</p>
<blockquote>
<div><p><a class="reference external" href="https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.4">https://codeload.github.com/GrahamDumpleton/mod_wsgi/tar.gz/4.4.4</a></p>
</div></blockquote>
...
<p>1. The <code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> command will now output to <code class="docutils literal notranslate"><span class="pre">stdout</span></code> the
number of daemon processes and threads being used.</p>
<p>2. Add automatic installation of precompiled Apache binaries when deploying
<code class="docutils literal notranslate"><span class="pre">mod_wsgi-express</span></code> to Heroku or OpenShift. These binaries will be pulled
down from S3 and installed as part of the mod_wsgi package.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="version-4.4.3.html" class="btn btn-neutral float-right" title="Version 4.4.3" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="version-4.4.5.html" class="btn btn-neutral float-left" title="Version 4.4.5" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
