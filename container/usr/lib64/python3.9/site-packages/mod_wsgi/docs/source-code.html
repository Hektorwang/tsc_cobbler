...
<head>
  ...
  <title>Source Code &mdash; mod_wsgi 4.7.1 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/source-code.rst.txt" rel="nofollow"> View page source</a>
...
<p>The source code repository for mod_wsgi is located on GitHub at:</p>
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi">https://github.com/GrahamDumpleton/mod_wsgi</a></p></li>
</ul>
<p>Downloadable tar balls of the source code can be found at:</p>
<ul class="simple">
...
<p>A version of the source code which can be installed using <code class="docutils literal notranslate"><span class="pre">pip</span></code> can
also be found on PyPi at:</p>
<ul class="simple">
<li><p><a class="reference external" href="https://pypi.python.org/pypi/mod_wsgi">https://pypi.python.org/pypi/mod_wsgi</a></p></li>
</ul>
</div>
