...
<head>
  ...
  <title>Issues With Expat Library &mdash; mod_wsgi 4.7.1 documentation</title>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">[</span><span class="n">notice</span><span class="p">]</span> <span class="n">child</span> <span class="n">pid</span> <span class="mi">3238</span> <span class="n">exit</span> <span class="n">signal</span> <span class="n">Segmentation</span> <span class="n">fault</span> <span class="p">(</span><span class="mi">11</span><span class="p">)</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">pyexpat</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>[grahamd@dscpl grahamd]$ ldd /usr/sbin/httpd | grep expat
...
starting with <code class="docutils literal notranslate"><span class="pre">expat_</span></code>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>[grahamd@dscpl grahamd]$ strings /usr/lib/libexpat.so.0 | grep expat_
expat_1.95.8
</pre></div>
</div>
...
root:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>[grahamd@dscpl grahamd]$ ps aux | grep http | head -3
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>[grahamd@dscpl grahamd]$ python
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>[grahamd@dscpl grahamd]$ LD_PRELOAD=/usr/lib/libexpat.so.0.5.0 python
Python 2.3.3 (#1, May  7 2004, 10:31:40)
[GCC 3.3.3 20040412 (Red Hat Linux 3.3.3-7)] on linux2
Type &quot;help&quot;, &quot;copyright&quot;, &quot;credits&quot; or &quot;license&quot; for more information.
&gt;&gt;&gt; import pyexpat
...
“expat” library as used in Python.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="issues-with-pickle-module.html" class="btn btn-neutral float-left" title="Issues With Pickle Module" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
