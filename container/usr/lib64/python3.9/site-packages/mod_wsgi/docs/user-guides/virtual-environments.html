...
<head>
  ...
  <title>Virtual Environments &mdash; mod_wsgi 4.7.1 documentation</title>
...
the <code class="docutils literal notranslate"><span class="pre">pyvenv</span></code> or <code class="docutils literal notranslate"><span class="pre">python</span> <span class="pre">-m</span> <span class="pre">venv</span></code> commands.</p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">python</span> <span class="o">-</span><span class="n">c</span> <span class="s1">&#39;import sys; print(sys.prefix)&#39;</span>
</pre></div>
</div>
...
under the <code class="docutils literal notranslate"><span class="pre">/usr/local/venvs</span></code> directory. A specific Python virtual
environment may thus return for <code class="docutils literal notranslate"><span class="pre">sys.prefix</span></code>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">venvs</span><span class="o">/</span><span class="n">example</span>
</pre></div>
</div>
<p>Note that this should be the root directory of the Python virtual
environment, which in turn contains the <code class="docutils literal notranslate"><span class="pre">bin</span></code> and <code class="docutils literal notranslate"><span class="pre">lib</span></code> directories for
...
<code class="docutils literal notranslate"><span class="pre">python</span></code> executable instead of the root directory. That will not work, so
do not use the path for the <code class="docutils literal notranslate"><span class="pre">python</span></code> executable as the location of the
...
it does not run the command line <code class="docutils literal notranslate"><span class="pre">python</span></code> program to run the interpreter
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">myapp</span>
...
<p>The <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive defines the daemon process group. The
<code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span></code> directive indicates that the WSGI application should be
run within the defined daemon process group.</p>
<p>As only the single application is being run within the daemon process
group, the <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> directive is also being used. When this
is used with the <code class="docutils literal notranslate"><span class="pre">%{GLOBAL}</span></code> value, it forces the WSGI application to run
...
environment, all you need to do is add the <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option to the
<code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive resulting in:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">myapp</span> <span class="n">python</span><span class="o">-</span><span class="n">home</span><span class="o">=/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">venvs</span><span class="o">/</span><span class="n">myapp</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">myapps</span>
...
<p>The use of the <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> and <code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span></code> is the same as
before, however the <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> directive is not being used.</p>
<p>When the <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> directive isn’t being used to override
...
application case would be made. That is, add the <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option
to the <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive:</p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">python_home</span> <span class="o">=</span> <span class="s1">&#39;/usr/local/envs/myapp1&#39;</span>
...
environment, the value of the <code class="docutils literal notranslate"><span class="pre">python_home</span></code> variable would be set
...
imports in the WSGI script file, with the exception of <code class="docutils literal notranslate"><span class="pre">from</span> <span class="pre">__future__</span></code>
...
<code class="docutils literal notranslate"><span class="pre">python-home</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> is used.</p>
<p>When activating the Python virtual environment from within the WSGI script
file, only the <code class="docutils literal notranslate"><span class="pre">site-packages</span></code> directory from the Python virtual
...
<code class="docutils literal notranslate"><span class="pre">site-packages</span></code> directory registered using <code class="docutils literal notranslate"><span class="pre">.pth</span></code> files present in the
<code class="docutils literal notranslate"><span class="pre">site-packages</span></code> directory. This will be placed at the start of the
existing <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.</p>
...
had all the packages you require listed in your <code class="docutils literal notranslate"><span class="pre">requirements.txt</span></code> file
for <code class="docutils literal notranslate"><span class="pre">pip</span></code>, but didn’t and so a package may not have been installed. If
...
<code class="docutils literal notranslate"><span class="pre">python-home</span></code> option of the <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive, but set it to
...
environment. This is because they both provide the <code class="docutils literal notranslate"><span class="pre">activate_this.py</span></code>
script file which does all the work of setting up <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>. When you
use either <code class="docutils literal notranslate"><span class="pre">pyvenv</span></code> or <code class="docutils literal notranslate"><span class="pre">python</span> <span class="pre">-m</span> <span class="pre">venv</span></code> with Python 3, no such
...
some reason and are stuck with <code class="docutils literal notranslate"><span class="pre">pyvenv</span></code> or <code class="docutils literal notranslate"><span class="pre">python</span> <span class="pre">-m</span> <span class="pre">venv</span></code>, you can
...
other module imports in the WSGI script file, with the exception of <code class="docutils literal notranslate"><span class="pre">from</span>
...
search path are made at the end of <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>. For that reason, you must
set the <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> to the location of
...
<p>There is extra code you could add which would reorder <code class="docutils literal notranslate"><span class="pre">sys.path</span></code> to make
it work in an equivalent way to the <code class="docutils literal notranslate"><span class="pre">activate_this.py</span></code> script provided
...
group per WSGI application. At the minimum, at least avoid <code class="docutils literal notranslate"><span class="pre">pyvenv</span></code> and
<code class="docutils literal notranslate"><span class="pre">python</span> <span class="pre">-m</span> <span class="pre">venv</span></code>.</p>
</div>
...
case of embedded mode, there is though no <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive.</p>
<p>The typical configuration when running a single WSGI application in
embedded module might be:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIScriptAlias</span> <span class="o">/</span> <span class="o">/</span><span class="n">some</span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">project</span><span class="o">/</span><span class="n">myapp</span><span class="o">.</span><span class="n">wsgi</span>
...
<p>The <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> and <code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span></code> directives are gone, but
the <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> directive is still used to force the WSGI
...
to be used, the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive is used:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIPythonHome</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">envs</span><span class="o">/</span><span class="n">myapp</span>
</pre></div>
</div>
<p>Note that if the WSGI application is being setup within the context of an
Apache <code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>, the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> cannot be placed inside of
the <code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>. Instead it must be placed outside of all
<code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code> definitions. This is because it applies to the whole Apache
instance and not just the single <code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>.</p>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIScriptAlias</span> <span class="o">/</span><span class="n">myapp3</span> <span class="o">/</span><span class="n">some</span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">project</span><span class="o">/</span><span class="n">myapp3</span><span class="o">.</span><span class="n">wsgi</span>
<span class="n">WSGIScriptAlias</span> <span class="o">/</span><span class="n">myapp2</span> <span class="o">/</span><span class="n">some</span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">project</span><span class="o">/</span><span class="n">myapp2</span><span class="o">.</span><span class="n">wsgi</span>
...
<p>If instead the directory containing the WSGI application script files is
being mounted, you might be using:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIScriptAlias</span> <span class="o">/</span> <span class="o">/</span><span class="n">some</span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">project</span><span class="o">/</span>
...
<p>In this scenario, to set the location of the Python virtual environment
to be used by all WSGI application, the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive is used:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIPythonHome</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">envs</span><span class="o">/</span><span class="n">myapps</span>
</pre></div>
</div>
<p>If the WSGI application is being setup within the context of an Apache
<code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>, the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> cannot be placed inside of the
<code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>. Instead it must be placed outside of all <code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>
definitions. This is because it applies to the whole Apache instance and
not just the single <code class="docutils literal notranslate"><span class="pre">VirtualHost</span></code>.</p>
...
being used. The <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive should be used to refer to an
...
<p>The <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option to <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> and the
<code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive are the preferred way of specifying the
...
Python module search path, you can use the <code class="docutils literal notranslate"><span class="pre">python-path</span></code> option to
<code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code>:</p>
...
<p>This option would be in addition to the <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option used to
specify where the Python virtual environment is located.</p>
<p>If you are using embedded mode, you can use the <code class="docutils literal notranslate"><span class="pre">WSGIPythonPath</span></code>
directive:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIPythonPath</span> <span class="o">/</span><span class="n">some</span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">project</span>
</pre></div>
</div>
<p>This directive is in addition to the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive used to
specify where the Python virtual environment is located.</p>
...
search path, you should modify <code class="docutils literal notranslate"><span class="pre">sys.path</span></code> directly from the WSGI script
file.</p>
...
environment. Specifically, they were used to add the <code class="docutils literal notranslate"><span class="pre">site-packages</span></code>
...
using the <code class="docutils literal notranslate"><span class="pre">python-home</span></code> option of the <code class="docutils literal notranslate"><span class="pre">WSGIDaemonProcess</span></code> directive for
daemon mode, or the <code class="docutils literal notranslate"><span class="pre">WSGIPythonHome</span></code> directive for embedded mode. These
...
update your configurations.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="access-control-mechanisms.html" class="btn btn-neutral float-right" title="Access Control Mechanisms" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="reloading-source-code.html" class="btn btn-neutral float-left" title="Reloading Source Code" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
