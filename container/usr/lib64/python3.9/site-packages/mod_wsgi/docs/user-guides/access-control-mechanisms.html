...
<head>
  ...
  <title>Access Control Mechanisms &mdash; mod_wsgi 4.7.1 documentation</title>
...
<code class="docutils literal notranslate"><span class="pre">AUTH_TYPE</span></code> of the WSGI application environment. The login name of the
...
<code class="docutils literal notranslate"><span class="pre">HTTP_AUTHORIZATION</span></code> variable of the WSGI application environment when
...
function with a sample as shown below:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">groups_for_user</span><span class="p">(</span><span class="n">environ</span><span class="p">,</span> <span class="n">user</span><span class="p">):</span>
    <span class="k">if</span> <span class="n">user</span> <span class="o">==</span> <span class="s1">&#39;spy&#39;</span><span class="p">:</span>
...
overridden using the ‘application-group’ option to the script directive.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="file-wrapper-extension.html" class="btn btn-neutral float-right" title="File Wrapper Extension" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="virtual-environments.html" class="btn btn-neutral float-left" title="Virtual Environments" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
