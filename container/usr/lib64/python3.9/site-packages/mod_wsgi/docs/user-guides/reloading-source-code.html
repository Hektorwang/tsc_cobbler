...
<head>
  ...
  <title>Reloading Source Code &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="Virtual Environments" href="virtual-environments.html" />
    <link rel="prev" title="Processes And Threading" href="processes-and-threading.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Reloading Source Code</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#embedded-mode-vs-daemon-mode">Embedded Mode Vs Daemon Mode</a></li>
<li class="toctree-l3"><a class="reference internal" href="#reloading-in-embedded-mode">Reloading In Embedded Mode</a></li>
<li class="toctree-l3"><a class="reference internal" href="#restarting-apache-processes">Restarting Apache Processes</a></li>
<li class="toctree-l3"><a class="reference internal" href="#reloading-in-daemon-mode">Reloading In Daemon Mode</a></li>
<li class="toctree-l3"><a class="reference internal" href="#restarting-daemon-processes">Restarting Daemon Processes</a></li>
<li class="toctree-l3"><a class="reference internal" href="#monitoring-for-code-changes">Monitoring For Code Changes</a></li>
<li class="toctree-l3"><a class="reference internal" href="#restarting-windows-apache">Restarting Windows Apache</a></li>
</ul>
</li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>Reloading Source Code</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="../_sources/user-guides/reloading-source-code.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="reloading-source-code">
<h1>Reloading Source Code<a class="headerlink" href="#reloading-source-code" title="Permalink to this headline">¶</a></h1>
...
any issues related to those mechanisms.</p>
<div class="section" id="embedded-mode-vs-daemon-mode">
<h2>Embedded Mode Vs Daemon Mode<a class="headerlink" href="#embedded-mode-vs-daemon-mode" title="Permalink to this headline">¶</a></h2>
<p>What is achievable in the way of automatic source code reloading depends on
which mode your WSGI application is running.</p>
<p>If your WSGI application is running in embedded mode then what happens when
...
changes to be used.</p>
<p>If using daemon mode, because mod_wsgi manages directly the processes
handling requests and in which your WSGI application runs, there is more
avenue for performing automatic source code reloading.</p>
<p>As a consequence, it is important to understand what mode your WSGI
application is running in.</p>
<p>If you are running on Windows, are using Apache 1.3, or have not used
...
embedded mode.</p>
<p>If you are not sure whether you are using embedded mode or daemon mode,
then substitute your WSGI application entry point with:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">application</span><span class="p">(</span><span class="n">environ</span><span class="p">,</span> <span class="n">start_response</span><span class="p">):</span>
    ...
    <span class="k">if</span> <span class="ow">not</span> <span class="n">environ</span><span class="p">[</span><span class="s1">&#39;mod_wsgi.process_group&#39;</span><span class="p">]:</span>
      <span class="n">output</span> <span class="o">=</span> <span class="sa">u</span><span class="s1">&#39;EMBEDDED MODE&#39;</span>
    <span class="k">else</span><span class="p">:</span>
      <span class="n">output</span> <span class="o">=</span> <span class="sa">u</span><span class="s1">&#39;DAEMON MODE&#39;</span>
...
<p>If your WSGI application is running in embedded mode, this will output to
the browser ‘EMBEDDED MODE’. If your WSGI application is running in daemon
mode, this will output to the browser ‘DAEMON MODE’.</p>
</div>
<div class="section" id="reloading-in-embedded-mode">
<h2>Reloading In Embedded Mode<a class="headerlink" href="#reloading-in-embedded-mode" title="Permalink to this headline">¶</a></h2>
<p>However you have configured Apache to mount your WSGI application, you will
...
extension not be used for reasons described below.</p>
<p>For embedded mode, one of the properties of the script file is that by
...
Apache even for a trivial change to the script file.</p>
<p>Do note though that this script reloading mechanism is not intended as a
...
still need to restart Apache.</p>
<p>That only the script file and not the whole process is reloaded also has a
number of implications and imposes certain restrictions on what code in the
script file can do or how it should be implemented.</p>
<p>The first issue is that when the script file is imported, if the code makes
modifications to <code class="docutils literal notranslate"><span class="pre">sys.path</span></code> or other global data structures and the
...
script file is reloaded.</p>
<p>This means that when updating <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>, instead of using:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">sys</span>
<span class="n">sys</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="s1">&#39;/usr/local/wsgi/modules&#39;</span><span class="p">)</span>
</pre></div>
</div>
<p>the more correct way would be to use:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">sys</span>
<span class="n">path</span> <span class="o">=</span> <span class="s1">&#39;/usr/local/wsgi/modules&#39;</span>
...
<p>This will ensure that the path doesn’t get added multiple times.</p>
<p>Even where the script file is named so as to have a ‘.py’ extension, that
...
the directory containing the script into <code class="docutils literal notranslate"><span class="pre">sys.path</span></code> explicitly.</p>
<p>If an attempt is made to import the script file as a module the result will
...
when loaded.</p>
<p>Because the script file is not treated like a normal Python module also has
implications when it comes to using the “pickle” module in conjunction
with objects contained within the script file.</p>
...
stored using the “pickle” module.</p>
<p>The technical reasons for the limitations on the use of the “pickle” module
in conjunction with objects defined in the script file are further
discussed in the document <a class="reference internal" href="issues-with-pickle-module.html"><span class="doc">Issues With Pickle Module</span></a>.</p>
<p>The act of reloading script files also means that any data previously held
...
leakage.</p>
<p>One should therefore be cautious of what data is kept in a script file.
...
<div class="section" id="restarting-apache-processes">
<h2>Restarting Apache Processes<a class="headerlink" href="#restarting-apache-processes" title="Permalink to this headline">¶</a></h2>
<p>As explained above, the only facility that mod_wsgi provides for reloading
source code files in embedded mode, is the reloading of just the script
file providing the entry point for your WSGI application.</p>
<p>If you don’t have a choice but to use embedded mode and still desire some
...
<p>To enable this, you need to modify the value of the MaxRequestsPerChild
...
after every request, set it to the value ‘1’ instead:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">MaxRequestsPerChild</span> <span class="mi">1</span>
</pre></div>
</div>
<p>Do note however that this will cause the process to be restarted after any
...
to your code.</p>
<p>Because a restart happens regardless of the request type, using this method
is not recommended.</p>
<p>Because of how the Apache server child processes are monitored and restarts
...
applications will not be affected.</p>
</div>
<div class="section" id="reloading-in-daemon-mode">
<h2>Reloading In Daemon Mode<a class="headerlink" href="#reloading-in-daemon-mode" title="Permalink to this headline">¶</a></h2>
<p>If using mod_wsgi daemon mode, what happens when the script file is changed
...
<p>Detection of the change in the script file will occur at the time of the
...
still being processed once the daemon process has been restarted.</p>
<p>In the case of there being multiple daemon processes in the process group,
then a cascade effect will occur, with successive processes being restarted
until the request is again routed to one of the newly restarted processes.</p>
<p>In this way, restarting of a WSGI application when a change has been made
...
the need to restart the whole of Apache.</p>
<p>So, if you are using Django in daemon mode and needed to change your
...
application reloaded.</p>
</div>
<div class="section" id="restarting-daemon-processes">
<h2>Restarting Daemon Processes<a class="headerlink" href="#restarting-daemon-processes" title="Permalink to this headline">¶</a></h2>
<p>If you are using daemon mode of mod_wsgi, restarting of processes can to a
degree also be controlled by a user, or by the WSGI application itself,
without restarting the whole of Apache.</p>
<p>To force a daemon process to be restarted, if you are using a single daemon
...
signal to itself.</p>
<p>This should only be done for daemon processes and not within the Apache
...
be non empty if a daemon process:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="n">environ</span><span class="p">[</span><span class="s1">&#39;mod_wsgi.process_group&#39;</span><span class="p">]</span> <span class="o">!=</span> <span class="s1">&#39;&#39;</span><span class="p">:</span>
...
<p>This will cause the daemon process your application is in to shutdown. The
...
special web page specifically for that purpose.</p>
<p>You can also send this signal from an external application, but a problem
...
as opposed to the Apache user, and send them all signals.</p>
<p>If the daemon process is running as the same user as Apache or there are
...
determine.</p>
<p>Either way, to make it easier to identify which processes belong to a
...
and not the name of the actual Apache server binary.</p>
</div>
<div class="section" id="monitoring-for-code-changes">
<h2>Monitoring For Code Changes<a class="headerlink" href="#monitoring-for-code-changes" title="Permalink to this headline">¶</a></h2>
<p>The use of signals to restart a daemon process could also be employed in a
...
a restart if they have.</p>
<p>Example code for such an automatic restart mechanism which is compatible
with how mod_wsgi works is shown below:</p>
...
<span class="k">def</span> <span class="nf">_restart</span><span class="p">(</span><span class="n">path</span><span class="p">):</span>
    ...
    <span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="si">%s</span><span class="s1"> Change detected to </span><span class="se">\&#39;</span><span class="si">%s</span><span class="se">\&#39;</span><span class="s1">.&#39;</span> <span class="o">%</span> <span class="p">(</span><span class="n">prefix</span><span class="p">,</span> <span class="n">path</span><span class="p">),</span> <span class="n">file</span><span class="o">=</span><span class="n">sys</span><span class="o">.</span><span class="n">stderr</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="si">%s</span><span class="s1"> Triggering process restart.&#39;</span> <span class="o">%</span> <span class="n">prefix</span><span class="p">,</span> <span class="n">file</span><span class="o">=</span><span class="n">sys</span><span class="o">.</span><span class="n">stderr</span><span class="p">)</span>
    <span class="n">os</span><span class="o">.</span><span class="n">kill</span><span class="p">(</span><span class="n">os</span><span class="o">.</span><span class="n">getpid</span><span class="p">(),</span> <span class="n">signal</span><span class="o">.</span><span class="n">SIGINT</span><span class="p">)</span>

<span class="k">def</span> <span class="nf">_modified</span><span class="p">(</span><span class="n">path</span><span class="p">):</span>
    <span class="k">try</span><span class="p">:</span>
        <span class="c1"># If path doesn&#39;t denote a file and were previously</span>
        <span class="c1"># tracking it, then it has been removed or the file type</span>
        <span class="c1"># has changed so force a restart. If not previously</span>
        <span class="c1"># tracking the file then we can ignore it as probably</span>
        <span class="c1"># pseudo reference such as when file extracted from a</span>
        <span class="c1"># collection of modules contained in a zip file.</span>
        ...
        <span class="c1"># Check for when file last modified.</span>
        ...
        <span class="c1"># Force restart when modification time has changed, even</span>
        <span class="c1"># if time now older, as that could indicate older file</span>
        <span class="c1"># has been restored.</span>
    ...
    <span class="k">except</span><span class="p">:</span>
        <span class="c1"># If any exception occured, likely that file has been</span>
        <span class="c1"># been removed just before stat(), so force a restart.</span>
...
<span class="k">def</span> <span class="nf">_monitor</span><span class="p">():</span>
    <span class="k">while</span> <span class="mi">1</span><span class="p">:</span>
        <span class="c1"># Check modification times on all files in sys.modules.</span>
        ...
        <span class="k">for</span> <span class="n">module</span> <span class="ow">in</span> <span class="n">sys</span><span class="o">.</span><span class="n">modules</span><span class="o">.</span><span class="n">values</span><span class="p">():</span>
            <span class="k">if</span> <span class="ow">not</span> <span class="nb">hasattr</span><span class="p">(</span><span class="n">module</span><span class="p">,</span> <span class="s1">&#39;__file__&#39;</span><span class="p">):</span>
                <span class="k">continue</span>
            <span class="n">path</span> <span class="o">=</span> <span class="nb">getattr</span><span class="p">(</span><span class="n">module</span><span class="p">,</span> <span class="s1">&#39;__file__&#39;</span><span class="p">)</span>
            <span class="k">if</span> <span class="ow">not</span> <span class="n">path</span><span class="p">:</span>
                <span class="k">continue</span>
            <span class="k">if</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">splitext</span><span class="p">(</span><span class="n">path</span><span class="p">)[</span><span class="mi">1</span><span class="p">]</span> <span class="ow">in</span> <span class="p">[</span><span class="s1">&#39;.pyc&#39;</span><span class="p">,</span> <span class="s1">&#39;.pyo&#39;</span><span class="p">,</span> <span class="s1">&#39;.pyd&#39;</span><span class="p">]:</span>
        ...
        <span class="c1"># Check modification times on files which have</span>
        <span class="c1"># specifically been registered for monitoring.</span>
...
<span class="k">def</span> <span class="nf">start</span><span class="p">(</span><span class="n">interval</span><span class="o">=</span><span class="mf">1.0</span><span class="p">):</span>
    ...
    <span class="k">if</span> <span class="ow">not</span> <span class="n">_running</span><span class="p">:</span>
        <span class="n">prefix</span> <span class="o">=</span> <span class="s1">&#39;monitor (pid=</span><span class="si">%d</span><span class="s1">):&#39;</span> <span class="o">%</span> <span class="n">os</span><span class="o">.</span><span class="n">getpid</span><span class="p">()</span>
        <span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="si">%s</span><span class="s1"> Starting change monitor.&#39;</span> <span class="o">%</span> <span class="n">prefix</span><span class="p">,</span> <span class="n">file</span><span class="o">=</span><span class="n">sys</span><span class="o">.</span><span class="n">stderr</span><span class="p">)</span>
...
<p>This would be used by importing into the script file the Python module
containing the above code, starting the monitoring system and adding any
additional non Python files which should be tracked:</p>
...
<span class="n">monitor</span><span class="o">.</span><span class="n">track</span><span class="p">(</span><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">dirname</span><span class="p">(</span><span class="vm">__file__</span><span class="p">),</span> <span class="s1">&#39;site.cf&#39;</span><span class="p">))</span>

<span class="k">def</span> <span class="nf">application</span><span class="p">(</span><span class="n">environ</span><span class="p">,</span> <span class="n">start_response</span><span class="p">):</span>
    <span class="o">...</span>
</pre></div>
</div>
<p>Where needing to add many non Python files in a directory hierarchy, such
as template files which would otherwise be cached within the running
process, the <code class="docutils literal notranslate"><span class="pre">os.path.walk()</span></code> function could be used to traverse
all files and add required files based on extension or other criteria
using the ‘track()’ function.</p>
<p>This mechanism would generally work adequately where a single daemon
...
between scans, however that will increase the overhead of the checks.</p>
<p>Using such an approach may in some cases be useful if using mod_wsgi as a
development platform. It certainly would not be recommended you use this
mechanism for a production system.</p>
<p>The reasons for not using it on a production system is due to the
...
loaded and the application will fail.</p>
<p>Note that you should also not use this mechanism on a system where you have
...
request.</p>
<p>If preloading was really required, the example code would need to be
...
that approach if it is warranted.</p>
</div>
<div class="section" id="restarting-windows-apache">
<h2>Restarting Windows Apache<a class="headerlink" href="#restarting-windows-apache" title="Permalink to this headline">¶</a></h2>
<p>On the Windows platform there is no daemon mode only embedded mode. The MPM
used on Apache is the ‘winnt’ MPM. This MPM is like the worker MPM on UNIX
systems except that there is only one process.</p>
<p>Being embedded mode, modifying the WSGI script file only results in the WSGI
...
application reloaded automatically.</p>
<p>The recipe in the previous section can be used with daemon mode on UNIX
...
‘fork()’ system call daemon mode isn’t supported in the first place.</p>
<p>Thus, the only way one can have code changes picked up on Windows is to
...
<p>With that in mind, it is actually possible to modify the prior recipe for
...
of Apache called ‘ap_signal_parent()’.</p>
<p>The required change to get this to work is to replace the restart
function in the previous code with the following:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">_restart</span><span class="p">(</span><span class="n">path</span><span class="p">):</span>
    <span class="n">_queue</span><span class="o">.</span><span class="n">put</span><span class="p">(</span><span class="kc">True</span><span class="p">)</span>
    <span class="n">prefix</span> <span class="o">=</span> <span class="s1">&#39;monitor (pid=</span><span class="si">%d</span><span class="s1">):&#39;</span> <span class="o">%</span> <span class="n">os</span><span class="o">.</span><span class="n">getpid</span><span class="p">()</span>
    <span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="si">%s</span><span class="s1"> Change detected to </span><span class="se">\&#39;</span><span class="si">%s</span><span class="se">\&#39;</span><span class="s1">.&#39;</span> <span class="o">%</span> <span class="p">(</span><span class="n">prefix</span><span class="p">,</span> <span class="n">path</span><span class="p">),</span> <span class="n">file</span><span class="o">=</span><span class="n">sys</span><span class="o">.</span><span class="n">stderr</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="si">%s</span><span class="s1"> Triggering Apache restart.&#39;</span> <span class="o">%</span> <span class="n">prefix</span><span class="p">,</span> <span class="n">file</span><span class="o">=</span><span class="n">sys</span><span class="o">.</span><span class="n">stderr</span><span class="p">)</span>
    <span class="kn">import</span> <span class="nn">ctypes</span>
    <span class="n">ctypes</span><span class="o">.</span><span class="n">windll</span><span class="o">.</span><span class="n">libhttpd</span><span class="o">.</span><span class="n">ap_signal_parent</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
</pre></div>
</div>
<p>Other than that, the prior code would be used exactly as before. Now when
any change is made to Python code used by the application or any other
monitored files, Apache will be restarted automatically for you.</p>
<p>As before, probably recommended that this only be used during development
and not on a production system.</p>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="virtual-environments.html" class="btn btn-neutral float-right" title="Virtual Environments" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="processes-and-threading.html" class="btn btn-neutral float-left" title="Processes And Threading" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
