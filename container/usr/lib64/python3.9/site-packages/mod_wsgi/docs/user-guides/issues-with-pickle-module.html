...
<head>
  ...
  <title>Issues With Pickle Module &mdash; mod_wsgi 4.7.1 documentation</title>
...
<code class="docutils literal notranslate"><span class="pre">sys.path</span></code> using the ‘import’ statement are not affected.</p>
...
of exception:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">def</span> <span class="nf">a</span><span class="p">():</span> <span class="k">pass</span>
<span class="gp">...</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">pickle</span><span class="o">.</span><span class="n">dumps</span><span class="p">(</span><span class="n">z</span><span class="p">)</span>
<span class="gp">... </span><span class="o">&lt;</span><span class="n">deleted</span><span class="o">&gt;</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">B</span><span class="p">:</span> <span class="k">pass</span>
<span class="gp">...</span>
...
<code class="docutils literal notranslate"><span class="pre">sys.modules</span></code> under that name. Further, that name must be able to be
used to import the module.</p>
<p>The mod_wsgi script loading mechanism does not place modules in
<code class="docutils literal notranslate"><span class="pre">sys.modules</span></code> under their original name so as to allow multiple modules
with the same name in different directories and also to avoid having to use
the “.py” extension for script files.</p>
<p>The consequence though of modules not residing in <code class="docutils literal notranslate"><span class="pre">sys.modules</span></code> under
...
session:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">exec</span> <span class="s2">&quot;class C: pass&quot;</span> <span class="ow">in</span> <span class="n">m</span><span class="o">.</span><span class="vm">__dict__</span>
...
resulting from how mod_wsgi names modules when stored in <code class="docutils literal notranslate"><span class="pre">sys.modules</span></code>.</p>
...
statement.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="issues-with-expat-library.html" class="btn btn-neutral float-right" title="Issues With Expat Library" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="assorted-tips-and-tricks.html" class="btn btn-neutral float-left" title="Assorted Tips And Tricks" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
