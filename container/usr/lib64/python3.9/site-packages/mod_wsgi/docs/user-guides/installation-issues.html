...
<head>
  ...
  <title>Installation Issues &mdash; mod_wsgi 4.7.1 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/user-guides/installation-issues.rst.txt" rel="nofollow"> View page source</a>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">.</span><span class="n">c</span><span class="p">:</span><span class="mi">113</span><span class="p">:</span><span class="mi">20</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">Python</span><span class="o">.</span><span class="n">h</span><span class="p">:</span> <span class="n">No</span> <span class="n">such</span> <span class="n">file</span> <span class="ow">or</span> <span class="n">directory</span>
...
<code class="docutils literal notranslate"><span class="pre">-dev</span></code> appended to the package name. You will need to lookup up list of
...
<code class="docutils literal notranslate"><span class="pre">--enable-shared</span></code> option to enable the production and use of a shared
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ls -las
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ln -s ../../libpython2.5.so .
</pre></div>
</div>
...
necessary to ensure that a specific version is used, the <code class="docutils literal notranslate"><span class="pre">--with-python</span></code>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="s1">&#39;import site&#39;</span> <span class="n">failed</span><span class="p">;</span> <span class="n">use</span> <span class="o">-</span><span class="n">v</span> <span class="k">for</span> <span class="n">traceback</span>
</pre></div>
</div>
...
for the version of Python being used and passed to the <code class="docutils literal notranslate"><span class="pre">--with-python</span></code>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>PATH=/usr/local/bin:$PATH
export PATH
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="p">:</span> <span class="n">Compiled</span> <span class="k">for</span> <span class="n">Python</span><span class="o">/</span><span class="mf">2.4</span><span class="o">.</span><span class="mf">1.</span>
...
were originally installed with the <code class="docutils literal notranslate"><span class="pre">--enable-shared</span></code> option supplied to
...
<p>If <code class="docutils literal notranslate"><span class="pre">--enable-shared</span></code> was however not used and the Python library is
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>/bin/sh /usr/lib64/apr/build/libtool --silent --mode=link gcc -o \
...
and may actually be necessary, to ensure that the <code class="docutils literal notranslate"><span class="pre">--enable-shared</span></code> option
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">error</span> <span class="k">while</span> <span class="n">loading</span> <span class="n">shared</span> <span class="n">libraries</span><span class="p">:</span> <span class="n">libpython2</span><span class="o">.</span><span class="mf">4.</span><span class="n">so</span><span class="o">.</span><span class="mf">1.0</span><span class="p">:</span> \
...
problem is that the symbol <code class="docutils literal notranslate"><span class="pre">__stack_chk_fail_local</span></code> is being flagged as
undefined:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ invoke-rc.d apache2 reload
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">CFLAGS</span> <span class="o">=</span> <span class="o">-</span><span class="n">Wc</span><span class="p">,</span><span class="o">-</span><span class="n">fno</span><span class="o">-</span><span class="n">stack</span><span class="o">-</span><span class="n">protector</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">httpd</span><span class="p">:</span> <span class="n">Syntax</span> <span class="n">error</span> <span class="n">on</span> <span class="n">line</span> <span class="mi">54</span> <span class="n">of</span> <span class="o">/</span><span class="n">etc</span><span class="o">/</span><span class="n">httpd</span><span class="o">/</span><span class="n">conf</span><span class="o">/</span><span class="n">httpd</span><span class="o">.</span><span class="n">conf</span><span class="p">:</span> <span class="n">Cannot</span> \
...
<p>This problem can be fixed by adding <code class="docutils literal notranslate"><span class="pre">-lutil</span></code> to the list of libraries to
link mod_wsgi against when it is being built. This can be done by adding
<code class="docutils literal notranslate"><span class="pre">-lutil</span></code> to the ‘LDLIBS’ variable in the mod_wsgi ‘Makefile’ after having
run ‘configure’.</p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">LD_PRELOAD</span><span class="o">=/</span><span class="n">usr</span><span class="o">/</span><span class="n">lib</span><span class="o">/</span><span class="n">libutil</span><span class="o">.</span><span class="n">so</span>
...
are:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">In</span> <span class="n">file</span> <span class="n">included</span> <span class="kn">from</span> <span class="nn">mod_wsgi.c</span><span class="p">:</span><span class="mi">4882</span><span class="p">:</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">include</span><span class="o">/</span><span class="n">apache2</span><span class="o">/</span><span class="n">mpm_common</span><span class="o">.</span><span class="n">h</span><span class="p">:</span><span class="mi">46</span><span class="p">:</span><span class="mi">17</span><span class="p">:</span> <span class="n">error</span><span class="p">:</span> <span class="n">mpm</span><span class="o">.</span><span class="n">h</span><span class="p">:</span> <span class="n">No</span> <span class="n">such</span> <span class="n">file</span> <span class="ow">or</span> <span class="n">directory</span>
<span class="o">...</span>
...
the <code class="docutils literal notranslate"><span class="pre">--with-apxs</span></code> option to designate that either “apxs2-worker” or
...
complaints about <code class="docutils literal notranslate"><span class="pre">ap_strstr</span></code>, then your Apache installation has been
configured for maintainer mode:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mod_wsgi</span><span class="o">.</span><span class="n">c</span><span class="p">:</span> <span class="n">In</span> <span class="n">function</span> <span class="s1">&#39;wsgi_process_group&#39;</span><span class="p">:</span>
...
option <code class="docutils literal notranslate"><span class="pre">--enable-maintainer-mode</span></code> when configuring Apache prior to
installation. You would be able to tell at the time of compiling mod_wsgi
if this has been done as the option <code class="docutils literal notranslate"><span class="pre">-DAP_DEBUG</span></code> would be supplied to the
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">[</span><span class="n">crit</span><span class="p">]</span> <span class="n">file</span> <span class="n">http_filters</span><span class="o">.</span><span class="n">c</span><span class="p">,</span> <span class="n">line</span> <span class="mi">346</span><span class="p">,</span> <span class="n">assertion</span> <span class="s2">&quot;readbytes &gt; 0&quot;</span> <span class="n">failed</span>
...
<blockquote>
<div><ul class="simple">
<li><p><a class="reference external" href="https://issues.apache.org/bugzilla/show_bug.cgi?id=38014">https://issues.apache.org/bugzilla/show_bug.cgi?id=38014</a></p></li>
</ul>
</div></blockquote>
...
source code.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="configuration-issues.html" class="btn btn-neutral float-right" title="Configuration Issues" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="configuration-guidelines.html" class="btn btn-neutral float-left" title="Configuration Guidelines" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
