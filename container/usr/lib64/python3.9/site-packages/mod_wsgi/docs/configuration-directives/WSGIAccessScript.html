...
<head>
  ...
  <title>WSGIAccessScript &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIApplicationGroup" href="WSGIApplicationGroup.html" />
    <link rel="prev" title="WSGIAcceptMutex" href="WSGIAcceptMutex.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIAccessScript</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIAccessScript.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiaccessscript">
<h1>WSGIAccessScript<a class="headerlink" href="#wsgiaccessscript" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Specify script implementing host access controls.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIAccessScript</span></code> <em>path</em> [ <em>options</em> ]</p>
</dd>
...
<p>The <code class="docutils literal notranslate"><span class="pre">WSGIAccessScript</span></code> directive provides a mechanism for implementing
host access controls.</p>
<p>More detailed information on using the <code class="docutils literal notranslate"><span class="pre">WSGIAccessScript</span></code> directive
...
<p>The options which can be supplied to the <code class="docutils literal notranslate"><span class="pre">WSGIAccessScript</span></code> directive are:</p>
...
context of a daemon process.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIApplicationGroup.html" class="btn btn-neutral float-right" title="WSGIApplicationGroup" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIAcceptMutex.html" class="btn btn-neutral float-left" title="WSGIAcceptMutex" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
