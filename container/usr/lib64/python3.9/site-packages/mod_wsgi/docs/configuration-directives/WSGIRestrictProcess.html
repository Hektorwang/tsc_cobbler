...
<head>
  ...
  <title>WSGIRestrictProcess &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIRestrictSignal" href="WSGIRestrictSignal.html" />
    <link rel="prev" title="WSGIRestrictEmbedded" href="WSGIRestrictEmbedded.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIRestrictProcess</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIRestrictProcess.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgirestrictprocess">
<h1>WSGIRestrictProcess<a class="headerlink" href="#wsgirestrictprocess" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Restrict which daemon process groups can be selected.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictProcess</span></code> <em>group-1 group-2 …</em></p>
</dd>
<dt class="field-odd">Syntax</dt>
<dd class="field-odd"><p>WSGIRestrictProcess <em>group-1 group-2 …</em></p>
</dd>
<dt class="field-even">Context</dt>
<dd class="field-even"><p>server config, virtual host, directory</p>
</dd>
</dl>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIDaemonProcess</span> <span class="n">default</span> <span class="n">processes</span><span class="o">=</span><span class="mi">2</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>
...
<span class="n">ServerName</span> <span class="n">www</span><span class="o">.</span><span class="n">site</span><span class="o">.</span><span class="n">com</span>

<span class="n">WSGIDaemonProcess</span> <span class="n">bob</span><span class="p">:</span><span class="mi">1</span> <span class="n">user</span><span class="o">=</span><span class="n">bob</span> <span class="n">group</span><span class="o">=</span><span class="n">bob</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>
<span class="n">WSGIDaemonProcess</span> <span class="n">bob</span><span class="p">:</span><span class="mi">2</span> <span class="n">user</span><span class="o">=</span><span class="n">bob</span> <span class="n">group</span><span class="o">=</span><span class="n">bob</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>
<span class="n">WSGIDaemonProcess</span> <span class="n">bob</span><span class="p">:</span><span class="mi">3</span> <span class="n">user</span><span class="o">=</span><span class="n">bob</span> <span class="n">group</span><span class="o">=</span><span class="n">bob</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>

<span class="n">WSGIDaemonProcess</span> <span class="n">joe</span><span class="p">:</span><span class="mi">1</span> <span class="n">user</span><span class="o">=</span><span class="n">joe</span> <span class="n">group</span><span class="o">=</span><span class="n">joe</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>
<span class="n">WSGIDaemonProcess</span> <span class="n">joe</span><span class="p">:</span><span class="mi">2</span> <span class="n">user</span><span class="o">=</span><span class="n">joe</span> <span class="n">group</span><span class="o">=</span><span class="n">joe</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>
<span class="n">WSGIDaemonProcess</span> <span class="n">joe</span><span class="p">:</span><span class="mi">3</span> <span class="n">user</span><span class="o">=</span><span class="n">joe</span> <span class="n">group</span><span class="o">=</span><span class="n">joe</span> <span class="n">threads</span><span class="o">=</span><span class="mi">25</span>

<span class="n">SetEnv</span> <span class="n">PROCESS_GROUP</span> <span class="n">default</span>
...
<span class="o">&lt;</span><span class="n">Directory</span> <span class="o">/</span><span class="n">home</span><span class="o">/</span><span class="n">bob</span><span class="o">/</span><span class="n">public_html</span><span class="o">&gt;</span>
...
<span class="n">WSGIRestrictProcess</span> <span class="n">bob</span><span class="p">:</span><span class="mi">1</span> <span class="n">bob</span><span class="p">:</span><span class="mi">2</span> <span class="n">bob</span><span class="p">:</span><span class="mi">3</span>
<span class="n">SetEnv</span> <span class="n">PROCESS_GROUP</span> <span class="n">bob</span><span class="p">:</span><span class="mi">1</span>
...
<a class="reference external" href="http://httpd.apache.org/docs/2.2/mod/mod_env.html#setenv">SetEnv</a> directive:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">&lt;</span><span class="n">Files</span> <span class="n">blog</span><span class="o">.</span><span class="n">wsgi</span><span class="o">&gt;</span>
<span class="n">SetEnv</span> <span class="n">PROCESS_GROUP</span> <span class="n">bob</span><span class="p">:</span><span class="mi">2</span>
<span class="o">&lt;/</span><span class="n">Files</span><span class="o">&gt;</span>

<span class="o">&lt;</span><span class="n">Files</span> <span class="n">wiki</span><span class="o">.</span><span class="n">wsgi</span><span class="o">&gt;</span>
<span class="n">SetEnv</span> <span class="n">PROCESS_GROUP</span> <span class="n">bob</span><span class="p">:</span><span class="mi">3</span>
<span class="o">&lt;/</span><span class="n">Files</span><span class="o">&gt;</span>
</pre></div>
</div>
...
not available on Windows or when running Apache 1.3.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIRestrictSignal.html" class="btn btn-neutral float-right" title="WSGIRestrictSignal" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIRestrictEmbedded.html" class="btn btn-neutral float-left" title="WSGIRestrictEmbedded" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
