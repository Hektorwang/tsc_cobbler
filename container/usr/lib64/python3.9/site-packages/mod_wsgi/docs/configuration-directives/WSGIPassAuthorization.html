...
<head>
  ...
  <title>WSGIPassAuthorization &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIProcessGroup" href="WSGIProcessGroup.html" />
    <link rel="prev" title="WSGILazyInitialization" href="WSGILazyInitialization.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIPassAuthorization</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIPassAuthorization.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgipassauthorization">
<h1>WSGIPassAuthorization<a class="headerlink" href="#wsgipassauthorization" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable/Disable passing of authorisation headers.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIPassAuthorization</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIPassAuthorization</span> <span class="pre">Off</span></code></p>
</dd>
...
be set to <code class="docutils literal notranslate"><span class="pre">On</span></code> if the WSGI application was to handle authorisation
...
<code class="docutils literal notranslate"><span class="pre">REMOTE_USER</span></code>.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIProcessGroup.html" class="btn btn-neutral float-right" title="WSGIProcessGroup" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGILazyInitialization.html" class="btn btn-neutral float-left" title="WSGILazyInitialization" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
