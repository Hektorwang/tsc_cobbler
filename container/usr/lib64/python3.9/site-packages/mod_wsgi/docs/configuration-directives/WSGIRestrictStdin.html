...
<head>
  ...
  <title>WSGIRestrictStdin &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIRestrictStdout" href="WSGIRestrictStdout.html" />
    <link rel="prev" title="WSGIRestrictSignal" href="WSGIRestrictSignal.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIRestrictStdin</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIRestrictStdin.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgirestrictstdin">
<h1>WSGIRestrictStdin<a class="headerlink" href="#wsgirestrictstdin" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable restrictions on use of STDIN.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictStdin</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictStdin</span> <span class="pre">On</span></code></p>
</dd>
...
input directly from <code class="docutils literal notranslate"><span class="pre">sys.stdin</span></code>. This is because ways of hosting WSGI
...
directly read from <code class="docutils literal notranslate"><span class="pre">sys.stdin</span></code> it could interfere with the operation of
...
restricts access to <code class="docutils literal notranslate"><span class="pre">sys.stdin</span></code> and will raise an exception if an
attempt is made to use <code class="docutils literal notranslate"><span class="pre">sys.stdin</span></code> explicitly.</p>
...
being able to run an interactive Python debugger such as <code class="docutils literal notranslate"><span class="pre">pdb</span></code>.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIRestrictStdout.html" class="btn btn-neutral float-right" title="WSGIRestrictStdout" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIRestrictSignal.html" class="btn btn-neutral float-left" title="WSGIRestrictSignal" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
