...
<head>
  ...
  <title>WSGICallableObject &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGICaseSensitivity" href="WSGICaseSensitivity.html" />
    <link rel="prev" title="WSGIAuthUserScript" href="WSGIAuthUserScript.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGICallableObject</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGICallableObject.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgicallableobject">
<h1>WSGICallableObject<a class="headerlink" href="#wsgicallableobject" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Sets the name of the WSGI application callable.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGICallableObject</span></code> <em>name</em>
<code class="docutils literal notranslate"><span class="pre">WSGICallableObject</span> <span class="pre">%{ENV:variable}</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGICallableObject</span> <span class="pre">application</span></code></p>
</dd>
<dt class="field-even">Context</dt>
<dd class="field-even"><p>server config, virtual host, directory, .htaccess</p>
</dd>
<dt class="field-odd">Override</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">FileInfo</span></code></p>
</dd>
</dl>
...
<p>When <code class="docutils literal notranslate"><span class="pre">%{ENV}</span></code> is being used, the environment variable is looked-up via the
...
path to refer to a sub object of a module imported by the WSGI script file.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGICaseSensitivity.html" class="btn btn-neutral float-right" title="WSGICaseSensitivity" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIAuthUserScript.html" class="btn btn-neutral float-left" title="WSGIAuthUserScript" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
