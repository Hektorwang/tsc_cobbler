...
<head>
  ...
  <title>WSGIAuthUserScript &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGICallableObject" href="WSGICallableObject.html" />
    <link rel="prev" title="WSGIAuthGroupScript" href="WSGIAuthGroupScript.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIAuthUserScript</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIAuthUserScript.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiauthuserscript">
<h1>WSGIAuthUserScript<a class="headerlink" href="#wsgiauthuserscript" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Specify script implementing an authentication provider.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIAuthUserScript</span></code> <em>path</em> [ <em>options</em> ]</p>
</dd>
...
found in <a class="reference internal" href="../user-guides/access-control-mechanisms.html"><span class="doc">Access Control Mechanisms</span></a>.</p>
...
context of a daemon process.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGICallableObject.html" class="btn btn-neutral float-right" title="WSGICallableObject" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIAuthGroupScript.html" class="btn btn-neutral float-left" title="WSGIAuthGroupScript" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
