...
<head>
  ...
  <title>WSGIImportScript &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGILazyInitialization" href="WSGILazyInitialization.html" />
    <link rel="prev" title="WSGIDaemonProcess" href="WSGIDaemonProcess.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIImportScript</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIImportScript.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiimportscript">
<h1>WSGIImportScript<a class="headerlink" href="#wsgiimportscript" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Specify a script file to be loaded on process start.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIImportScript</span></code> <em>path</em> <code class="docutils literal notranslate"><span class="pre">[</span></code> <em>options</em> <code class="docutils literal notranslate"><span class="pre">]</span></code></p>
</dd>
...
<dl>
<dt><strong>process-group=name</strong></dt><dd><p>Specifies the name of the process group for which the script file will
be loaded.</p>
...
<dt><strong>application-group=name</strong></dt><dd><p>Specifies the name of the application group within the specified
...
group.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGILazyInitialization.html" class="btn btn-neutral float-right" title="WSGILazyInitialization" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIDaemonProcess.html" class="btn btn-neutral float-left" title="WSGIDaemonProcess" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
