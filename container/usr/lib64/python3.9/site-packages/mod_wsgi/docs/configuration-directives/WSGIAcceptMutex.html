...
<head>
  ...
  <title>WSGIAcceptMutex &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIAccessScript" href="WSGIAccessScript.html" />
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIAcceptMutex</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIAcceptMutex.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiacceptmutex">
<h1>WSGIAcceptMutex<a class="headerlink" href="#wsgiacceptmutex" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Specify type of accept mutex used by daemon processes.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIAcceptMutex</span> <span class="pre">Default</span></code> | <em>method</em></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIAcceptMutex</span> <span class="pre">Default</span></code></p>
</dd>
<dt class="field-even">Context</dt>
<dd class="field-even"><p>server config</p>
</dd>
</dl>
<p>The <code class="docutils literal notranslate"><span class="pre">WSGIAcceptMutex</span></code> directive sets the method that mod_wsgi will use to
...
<a class="reference external" href="http://httpd.apache.org/docs/2.4/mod/mpm_common.html#acceptmutex">AcceptMutex</a> directive.</p>
<p>Note that the <code class="docutils literal notranslate"><span class="pre">WSGIAcceptMutex</span></code> directive and corresponding features are
not available on Windows or when running Apache 1.3.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIAccessScript.html" class="btn btn-neutral float-right" title="WSGIAccessScript" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
