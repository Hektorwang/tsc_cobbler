...
<head>
  ...
  <title>WSGIPythonPath &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIRestrictEmbedded" href="WSGIRestrictEmbedded.html" />
    <link rel="prev" title="WSGIPythonOptimize" href="WSGIPythonOptimize.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIPythonPath</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIPythonPath.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgipythonpath">
<h1>WSGIPythonPath<a class="headerlink" href="#wsgipythonpath" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Additional directories to search for Python modules.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIPythonPath</span></code> <em>directory|directory-1:directory-2:…</em></p>
</dd>
<dt class="field-odd">Context</dt>
<dd class="field-odd"><p>server config</p>
</dd>
</dl>
...
the environment variable <code class="docutils literal notranslate"><span class="pre">PYTHONPATH</span></code> in the environment of the user
that Apache executes as. If this directive is used it will override any
setting of <code class="docutils literal notranslate"><span class="pre">PYTHONPATH</span></code> in the environment of the user that Apache
executes as. The end result is that the listed directories will be added
to <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.</p>
...
affect as having set the environment variable <code class="docutils literal notranslate"><span class="pre">PYTHONPATH</span></code>. In fact, if
<code class="docutils literal notranslate"><span class="pre">PYTHONPATH</span></code> is set in the environment of the user that Apache is
started as, any directories so defined will still be added to
<code class="docutils literal notranslate"><span class="pre">sys.path</span></code> and they will not be overridden.</p>
<p>The difference with this directive when using mod_wsgi 2.0 is that each
directory listed will be added to the end of <code class="docutils literal notranslate"><span class="pre">sys.path</span></code> by calling
<code class="docutils literal notranslate"><span class="pre">site.addsitedir()</span></code>. By using this function, as well as the directory
being added to <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>, any ‘.pth’ files located in the directories
...
also be added automatically to <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.</p>
...
are automatically added to <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>, the directive can be used to
point at the <code class="docutils literal notranslate"><span class="pre">site-packages</span></code> directory corresponding to a Python
virtual environment created by a tool such as <code class="docutils literal notranslate"><span class="pre">virtualenv</span></code>.</p>
...
case be responsible for initialising Python.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIRestrictEmbedded.html" class="btn btn-neutral float-right" title="WSGIRestrictEmbedded" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIPythonOptimize.html" class="btn btn-neutral float-left" title="WSGIPythonOptimize" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
