...
<head>
  ...
  <title>WSGIScriptReloading &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGISocketPrefix" href="WSGISocketPrefix.html" />
    <link rel="prev" title="WSGIScriptAliasMatch" href="WSGIScriptAliasMatch.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIScriptReloading</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIScriptReloading.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiscriptreloading">
<h1>WSGIScriptReloading<a class="headerlink" href="#wsgiscriptreloading" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable/Disable detection of WSGI script file changes.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIScriptReloading</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIScriptReloading</span> <span class="pre">On</span></code></p>
</dd>
...
whichever reloading mechanism is appropriate to the mode being used.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGISocketPrefix.html" class="btn btn-neutral float-right" title="WSGISocketPrefix" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIScriptAliasMatch.html" class="btn btn-neutral float-left" title="WSGIScriptAliasMatch" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
