...
<head>
  ...
  <title>WSGICaseSensitivity &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIChunkedRequest" href="WSGIChunkedRequest.html" />
    <link rel="prev" title="WSGICallableObject" href="WSGICallableObject.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGICaseSensitivity</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGICaseSensitivity.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgicasesensitivity">
<h1>WSGICaseSensitivity<a class="headerlink" href="#wsgicasesensitivity" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Define whether file system is case sensitive.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGICaseSensitivity</span> <span class="pre">On|Off</span></code></p>
</dd>
...
<p>Because it is set in the main server config it will apply to the whole
site. All paths therefore would need to be located in a filesystem with the
same case convention.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIChunkedRequest.html" class="btn btn-neutral float-right" title="WSGIChunkedRequest" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGICallableObject.html" class="btn btn-neutral float-left" title="WSGICallableObject" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
