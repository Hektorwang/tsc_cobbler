...
<head>
  ...
  <title>WSGIRestrictSignal &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIRestrictStdin" href="WSGIRestrictStdin.html" />
    <link rel="prev" title="WSGIRestrictProcess" href="WSGIRestrictProcess.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIRestrictSignal</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIRestrictSignal.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgirestrictsignal">
<h1>WSGIRestrictSignal<a class="headerlink" href="#wsgirestrictsignal" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable restrictions on use of signal().</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictSignal</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictSignal</span> <span class="pre">On</span></code></p>
</dd>
<dt class="field-even">Context</dt>
<dd class="field-even"><p>server config</p>
</dd>
</dl>
<p>A well behaved Python WSGI application should not in general register any
signal handlers of its own using <code class="docutils literal notranslate"><span class="pre">signal.signal()</span></code>. The reason for this
...
restricts use of <code class="docutils literal notranslate"><span class="pre">signal.signal()</span></code> and will ensure that any attempts
...
application should avoid the signals <code class="docutils literal notranslate"><span class="pre">SIGTERM</span></code>, <code class="docutils literal notranslate"><span class="pre">SIGINT</span></code>,
<code class="docutils literal notranslate"><span class="pre">SIGHUP</span></code>, <code class="docutils literal notranslate"><span class="pre">SIGWINCH</span></code> and <code class="docutils literal notranslate"><span class="pre">SIGUSR1</span></code> as these are all used by
Apache.</p>
<p>Apache will ensure that the signal <code class="docutils literal notranslate"><span class="pre">SIGPIPE</span></code> is set to <code class="docutils literal notranslate"><span class="pre">SIG_IGN</span></code>.
If a WSGI application needs to override this, it must ensure that it is
reset to <code class="docutils literal notranslate"><span class="pre">SIG_IGN</span></code> before any Apache code is run. In a multi threaded
MPM this would be practically impossible to ensure so it is preferable that
the handler for <code class="docutils literal notranslate"><span class="pre">SIG_PIPE</span></code> also not be changed.</p>
<p>Apache does not use <code class="docutils literal notranslate"><span class="pre">SIGALRM</span></code>, but it is generally preferable that
...
interpreter thread.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIRestrictStdin.html" class="btn btn-neutral float-right" title="WSGIRestrictStdin" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIRestrictProcess.html" class="btn btn-neutral float-left" title="WSGIRestrictProcess" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
