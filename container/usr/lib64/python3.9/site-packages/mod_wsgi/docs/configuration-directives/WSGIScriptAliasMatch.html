...
<head>
  ...
  <title>WSGIScriptAliasMatch &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIScriptReloading" href="WSGIScriptReloading.html" />
    <link rel="prev" title="WSGIScriptAlias" href="WSGIScriptAlias.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIScriptAliasMatch</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIScriptAliasMatch.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiscriptaliasmatch">
<h1>WSGIScriptAliasMatch<a class="headerlink" href="#wsgiscriptaliasmatch" title="Permalink to this headline">¶</a></h1>
...
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIScriptAliasMatch</span></code> <em>regex file-path|directory-path</em> <code class="docutils literal notranslate"><span class="pre">[</span></code> <em>options</em> <code class="docutils literal notranslate"><span class="pre">]</span></code></p>
</dd>
...
a directory where the script files use the <code class="docutils literal notranslate"><span class="pre">.wsgi</span></code> extension, but it
is desired that the extension not appear in the URL, use:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>WSGIScriptAliasMatch ^/wsgi-scripts/([^/]+) /web/wsgi-scripts/$1.wsgi
</pre></div>
</div>
...
<p>If both <code class="docutils literal notranslate"><span class="pre">process-group</span></code> and <code class="docutils literal notranslate"><span class="pre">application-group</span></code> options are set, and
...
the first request.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIScriptReloading.html" class="btn btn-neutral float-right" title="WSGIScriptReloading" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIScriptAlias.html" class="btn btn-neutral float-left" title="WSGIScriptAlias" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
