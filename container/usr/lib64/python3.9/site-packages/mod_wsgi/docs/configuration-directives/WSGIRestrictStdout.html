...
<head>
  ...
  <title>WSGIRestrictStdout &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIScriptAlias" href="WSGIScriptAlias.html" />
    <link rel="prev" title="WSGIRestrictStdin" href="WSGIRestrictStdin.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIRestrictStdout</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIRestrictStdout.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgirestrictstdout">
<h1>WSGIRestrictStdout<a class="headerlink" href="#wsgirestrictstdout" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable restrictions on use of STDOUT.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictStdout</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictStdout</span> <span class="pre">On</span></code></p>
</dd>
...
data directly to <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> or use the <code class="docutils literal notranslate"><span class="pre">print</span></code> statement without
...
application were to directly write to <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> it could interfere
...
restricts access to <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> and will raise an exception if an
attempt is made to use <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> explicitly.</p>
<p>The only time that one might want to remove this restriction is purely out
of convencience of being able to use the <code class="docutils literal notranslate"><span class="pre">print</span></code> statement during
debugging of an application, or if some third party module or WSGI
application was errornously using <code class="docutils literal notranslate"><span class="pre">print</span></code> when it shouldn’t. If
restrictions on using <code class="docutils literal notranslate"><span class="pre">sys.stdout</span></code> are removed, any data written to
it will instead be sent through to <code class="docutils literal notranslate"><span class="pre">sys.stderr</span></code> and will appear in
the Apache error log file.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIScriptAlias.html" class="btn btn-neutral float-right" title="WSGIScriptAlias" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIRestrictStdin.html" class="btn btn-neutral float-left" title="WSGIRestrictStdin" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
