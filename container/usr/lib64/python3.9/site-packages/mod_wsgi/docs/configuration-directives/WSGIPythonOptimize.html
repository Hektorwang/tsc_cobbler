...
<head>
  ...
  <title>WSGIPythonOptimize &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIPythonPath" href="WSGIPythonPath.html" />
    <link rel="prev" title="WSGIPythonHome" href="WSGIPythonHome.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIPythonOptimize</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIPythonOptimize.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgipythonoptimize">
<h1>WSGIPythonOptimize<a class="headerlink" href="#wsgipythonoptimize" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enables basic Python optimisation features.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIPythonOptimize</span> <span class="pre">[0|1|2]</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIPythonOptimize</span> <span class="pre">0</span></code></p>
</dd>
...
compiled (bytecode) files from <code class="docutils literal notranslate"><span class="pre">.pyc</span></code> to <code class="docutils literal notranslate"><span class="pre">.pyo</span></code>.</p>
...
memory footprint if all <code class="docutils literal notranslate"><span class="pre">.pyo</span></code> files were compiled at this optimisation
level, but may cause some Python packages which interrogate doc strings in
some way to fail.</p>
<p>Since all the installed <code class="docutils literal notranslate"><span class="pre">.pyo</span></code> files in your Python installation are
...
<code class="docutils literal notranslate"><span class="pre">.pyo</span></code> files will aready exist for modules in the standard Python
...
<p>Overall, if you do not understand what the normal ‘python’ executable <code class="docutils literal notranslate"><span class="pre">-O</span></code>
...
concerned.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIPythonPath.html" class="btn btn-neutral float-right" title="WSGIPythonPath" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIPythonHome.html" class="btn btn-neutral float-left" title="WSGIPythonHome" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
