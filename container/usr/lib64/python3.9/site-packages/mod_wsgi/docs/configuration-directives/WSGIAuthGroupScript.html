...
<head>
  ...
  <title>WSGIAuthGroupScript &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIAuthUserScript" href="WSGIAuthUserScript.html" />
    <link rel="prev" title="WSGIApplicationGroup" href="WSGIApplicationGroup.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIAuthGroupScript</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIAuthGroupScript.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiauthgroupscript">
<h1>WSGIAuthGroupScript<a class="headerlink" href="#wsgiauthgroupscript" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Specify script implementing group authorisation.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIAuthGroupScript</span></code> <em>path</em> [ <em>options</em> ]</p>
</dd>
<dt class="field-odd">Context</dt>
<dd class="field-odd"><p>directory, .htaccess</p>
</dd>
<dt class="field-even">Override</dt>
<dd class="field-even"><p>AuthConfig</p>
</dd>
</dl>
<p>The <code class="docutils literal notranslate"><span class="pre">WSGIAuthGroupScript</span></code> directive provides a mechanism for implementing
group authorisation using the Apache <code class="docutils literal notranslate"><span class="pre">Require</span></code> directive.</p>
<p>More detailed information on using the <code class="docutils literal notranslate"><span class="pre">WSGIAuthGroupScript</span></code> directive
can be found in <a class="reference internal" href="../user-guides/access-control-mechanisms.html"><span class="doc">Access Control Mechanisms</span></a>.</p>
<p>The options which can be supplied to the <code class="docutils literal notranslate"><span class="pre">WSGIAuthGroupScript</span></code> directive are:</p>
<p><strong>application-group=name</strong></p>
<blockquote>
<div><p>Specifies the name of the application group within the specified
process for which the script file will be loaded.</p>
<p>If the <code class="docutils literal notranslate"><span class="pre">application-group</span></code> option is not supplied, the special value
<code class="docutils literal notranslate"><span class="pre">%{GLOBAL}</span></code> which denotes that the script file be loaded within the
...
context of a daemon process.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIAuthUserScript.html" class="btn btn-neutral float-right" title="WSGIAuthUserScript" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIApplicationGroup.html" class="btn btn-neutral float-left" title="WSGIApplicationGroup" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
