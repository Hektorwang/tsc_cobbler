...
<head>
  ...
  <title>WSGIPythonEggs &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIPythonHome" href="WSGIPythonHome.html" />
    <link rel="prev" title="WSGIProcessGroup" href="WSGIProcessGroup.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIPythonEggs</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIPythonEggs.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgipythoneggs">
<h1>WSGIPythonEggs<a class="headerlink" href="#wsgipythoneggs" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Directory to use for Python eggs cache.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIPythonEggs</span></code> <em>directory</em></p>
</dd>
...
achieves the same affect as having set the <code class="docutils literal notranslate"><span class="pre">PYTHON_EGG_CACHE</span></code>
...
directive instead.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIPythonHome.html" class="btn btn-neutral float-right" title="WSGIPythonHome" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIProcessGroup.html" class="btn btn-neutral float-left" title="WSGIProcessGroup" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
