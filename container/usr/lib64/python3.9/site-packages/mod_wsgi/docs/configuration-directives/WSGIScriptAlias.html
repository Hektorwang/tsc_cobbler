...
<head>
  ...
  <title>WSGIScriptAlias &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIScriptAliasMatch" href="WSGIScriptAliasMatch.html" />
    <link rel="prev" title="WSGIRestrictStdout" href="WSGIRestrictStdout.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIScriptAlias</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIScriptAlias.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiscriptalias">
<h1>WSGIScriptAlias<a class="headerlink" href="#wsgiscriptalias" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Maps a URL to a filesystem location and designates the target as a WSGI script.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIScriptAlias</span></code> <em>URL-path file-path|directory-path</em> <code class="docutils literal notranslate"><span class="pre">[</span></code> <em>options</em> <code class="docutils literal notranslate"><span class="pre">]</span></code></p>
</dd>
...
<a class="reference external" href="http://httpd.apache.org/docs/2.2/mod/mod_alias.html#alias">Alias</a> directive, except that it additionally marks the target directory
as containing WSGI scripts, or marks the specific <em>file-path</em> as a script,
that should be processed by mod_wsgi’s <code class="docutils literal notranslate"><span class="pre">wsgi-script</span></code> handler.</p>
...
<p>For example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIScriptAlias</span> <span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">/</span> <span class="o">/</span><span class="n">web</span><span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">/</span>
</pre></div>
</div>
<p>A request for <code class="docutils literal notranslate"><span class="pre">http://www.example.com/wsgi-scripts/name</span></code> in this case
would cause the server to run the WSGI application defined in
<code class="docutils literal notranslate"><span class="pre">/web/wsgi-scripts/name</span></code>. This configuration is essentially equivalent
to:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Alias</span> <span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">/</span> <span class="o">/</span><span class="n">web</span><span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">/</span>
<span class="o">&lt;</span><span class="n">Location</span> <span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">&gt;</span>
...
<p>For example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIScriptAlias</span> <span class="o">/</span><span class="n">name</span> <span class="o">/</span><span class="n">web</span><span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">/</span><span class="n">name</span>
</pre></div>
</div>
<p>A request for <code class="docutils literal notranslate"><span class="pre">http://www.example.com/name</span></code> in this case would cause the
server to run the WSGI application defined in <code class="docutils literal notranslate"><span class="pre">/web/wsgi-scripts/name</span></code>.</p>
<p>If possible you should avoid placing WSGI scripts under the <a class="reference external" href="http://httpd.apache.org/docs/2.2/mod/core.html#documentroot">DocumentRoot</a>
...
<a class="reference external" href="Directory">Directory</a>, <a class="reference external" href="http://httpd.apache.org/docs/2.2/mod/core.html#sethandler">SetHandler</a> and <a class="reference external" href="http://httpd.apache.org/docs/2.2/mod/core.html#options">Options</a> as in:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">&lt;</span><span class="n">Directory</span> <span class="o">/</span><span class="n">usr</span><span class="o">/</span><span class="n">local</span><span class="o">/</span><span class="n">apache</span><span class="o">/</span><span class="n">htdocs</span><span class="o">/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">&gt;</span>
<span class="n">SetHandler</span> <span class="n">wsgi</span><span class="o">-</span><span class="n">script</span>
...
<a class="reference external" href="Directory">Directory</a> section.</p>
<p>Options which can be supplied to the <code class="docutils literal notranslate"><span class="pre">WSGIScriptAlias</span></code> directive are:</p>
<dl>
<dt><strong>process-group=name</strong></dt><dd><p>Defines which process group the WSGI application will be executed
in. All WSGI applications within the same process group will execute
within the context of the same group of daemon processes.</p>
<p>If the name is set to be <code class="docutils literal notranslate"><span class="pre">%{GLOBAL}</span></code> the process group name will
...
<dt><strong>application-group=name</strong></dt><dd><p>Defines which application group a WSGI application or set of WSGI
...
sub interpreter of the process handling the request.</p>
<p>If the name is set to be <code class="docutils literal notranslate"><span class="pre">%{GLOBAL}</span></code> the application group will be
...
<p>If both <code class="docutils literal notranslate"><span class="pre">process-group</span></code> and <code class="docutils literal notranslate"><span class="pre">application-group</span></code> options are set, the
WSGI script file will be pre-loaded when the process it is to run in is
started, rather than being lazily loaded on the first request.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIScriptAliasMatch.html" class="btn btn-neutral float-right" title="WSGIScriptAliasMatch" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIRestrictStdout.html" class="btn btn-neutral float-left" title="WSGIRestrictStdout" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
