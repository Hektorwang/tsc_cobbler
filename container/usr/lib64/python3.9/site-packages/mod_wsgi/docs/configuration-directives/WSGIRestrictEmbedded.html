...
<head>
  ...
  <title>WSGIRestrictEmbedded &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIRestrictProcess" href="WSGIRestrictProcess.html" />
    <link rel="prev" title="WSGIPythonPath" href="WSGIPythonPath.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIRestrictEmbedded</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIRestrictEmbedded.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgirestrictembedded">
<h1>WSGIRestrictEmbedded<a class="headerlink" href="#wsgirestrictembedded" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable restrictions on use of embedded mode.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictEmbedded</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIRestrictEmbedded</span> <span class="pre">Off</span></code></p>
</dd>
...
<p>For historical reasons and to maintain backward compatibility with old
...
mode.</p>
<p>This option does not exist on Windows or any other configuration where
daemon mode is not available.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIRestrictProcess.html" class="btn btn-neutral float-right" title="WSGIRestrictProcess" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIPythonPath.html" class="btn btn-neutral float-left" title="WSGIPythonPath" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
