...
<head>
  ...
  <title>WSGIApplicationGroup &mdash; mod_wsgi 4.7.1 documentation</title>
...
<dd class="field-odd"><p>Sets which application group WSGI application belongs to.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span> <span class="pre">name</span></code>
<code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span> <span class="pre">%{GLOBAL}</span></code>
<code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span> <span class="pre">%{SERVER}</span></code>
<code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span> <span class="pre">%{RESOURCE}</span></code>
<code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span> <span class="pre">%{ENV:variable}</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span> <span class="pre">%{RESOURCE}</span></code></p>
</dd>
<dt class="field-even">Context</dt>
<dd class="field-even"><p>server config, virtual host, directory</p>
</dd>
</dl>
<p>The <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> directive can be used to specify which
...
<p>Setting <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> doesn’t control what processes a request
is handled by, that is what the <code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span></code> directive does. In
other words, the <code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span></code> directive operates distinct from the
<code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> directive, with <code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span></code> dictating
what named group of processes a request is handled by, and
<code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> dictating which named Python sub interpreter
...
that process.</p>
<p>The argument to the <code class="docutils literal notranslate"><span class="pre">WSGIApplicationGroup</span></code> can be either one of four
...
<p>For example, if the virtual host <code class="docutils literal notranslate"><span class="pre">www.example.com</span></code> is handling
...
to <code class="docutils literal notranslate"><span class="pre">www.example.com</span></code>. If instead the virtual host was handling requests
...
as for the <code class="docutils literal notranslate"><span class="pre">%{SERVER}</span></code> variable, to which the value of WSGI environment
variable <code class="docutils literal notranslate"><span class="pre">SCRIPT_NAME</span></code> is appended separated by the file separator
character.</p>
<p>For example, if the virtual host <code class="docutils literal notranslate"><span class="pre">www.example.com</span></code> was handling
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">www</span><span class="o">.</span><span class="n">example</span><span class="o">.</span><span class="n">com</span><span class="p">:</span><span class="mi">8080</span><span class="o">|/</span><span class="n">wsgi</span><span class="o">-</span><span class="n">scripts</span><span class="o">/</span><span class="n">foo</span>
</pre></div>
</div>
<p>The effect of using the <code class="docutils literal notranslate"><span class="pre">%{RESOURCE}</span></code> variable expansion is for each
...
(if not found there) via <code class="docutils literal notranslate"><span class="pre">getenv()</span></code> from the Apache server process.</p>
</div></blockquote>
<p>In an Apache configuration file, environment variables accessible using
the <code class="docutils literal notranslate"><span class="pre">%{ENV}</span></code> variable reference can be setup by using directives such as
...
daemon process groups.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIAuthGroupScript.html" class="btn btn-neutral float-right" title="WSGIAuthGroupScript" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIAccessScript.html" class="btn btn-neutral float-left" title="WSGIAccessScript" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
