...
<head>
  ...
  <title>WSGILazyInitialization &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIPassAuthorization" href="WSGIPassAuthorization.html" />
    <link rel="prev" title="WSGIImportScript" href="WSGIImportScript.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGILazyInitialization</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGILazyInitialization.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgilazyinitialization">
<h1>WSGILazyInitialization<a class="headerlink" href="#wsgilazyinitialization" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Enable/disable lazy initialisation of Python.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGILazyInitialization</span> <span class="pre">On|Off</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGILazyInitialization</span> <span class="pre">On</span></code></p>
</dd>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">WSGIRestrictEmbedded</span> <span class="n">On</span>
</pre></div>
</div>
...
clean up after itself.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIPassAuthorization.html" class="btn btn-neutral float-right" title="WSGIPassAuthorization" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIImportScript.html" class="btn btn-neutral float-left" title="WSGIImportScript" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
