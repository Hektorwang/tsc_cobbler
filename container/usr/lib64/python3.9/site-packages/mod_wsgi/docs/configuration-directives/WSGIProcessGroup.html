...
<head>
  ...
  <title>WSGIProcessGroup &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/pygments.css" type="text/css" />
    ...
    <link rel="next" title="WSGIPythonEggs" href="WSGIPythonEggs.html" />
    <link rel="prev" title="WSGIPassAuthorization" href="WSGIPassAuthorization.html" /> 
</head>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">WSGIProcessGroup</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../_sources/configuration-directives/WSGIProcessGroup.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="wsgiprocessgroup">
<h1>WSGIProcessGroup<a class="headerlink" href="#wsgiprocessgroup" title="Permalink to this headline">¶</a></h1>
<dl class="field-list simple">
<dt class="field-odd">Description</dt>
<dd class="field-odd"><p>Sets which process group WSGI application is assigned to.</p>
</dd>
<dt class="field-even">Syntax</dt>
<dd class="field-even"><p><code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span> <span class="pre">%{GLOBAL}|%{ENV:variable}|name</span></code></p>
</dd>
<dt class="field-odd">Default</dt>
<dd class="field-odd"><p><code class="docutils literal notranslate"><span class="pre">WSGIProcessGroup</span> <span class="pre">%{GLOBAL}</span></code></p>
</dd>
...
are:</p>
<dl>
<dt><strong>%{GLOBAL}</strong></dt><dd><p>The process group name will be set to the empty string.</p>
...
<dt><strong>%{ENV:variable}</strong></dt><dd><p>The process group name will be set to the value of the named
...
available on Windows or when running Apache 1.3.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        <a href="WSGIPythonEggs.html" class="btn btn-neutral float-right" title="WSGIPythonEggs" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
        <a href="WSGIPassAuthorization.html" class="btn btn-neutral float-left" title="WSGIPassAuthorization" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
