...
<head>
  ...
  <title>Reporting Bugs &mdash; mod_wsgi 4.7.1 documentation</title>
  ...
  <link rel="stylesheet" href="_static/pygments.css" type="text/css" />
    ...
    <link rel="prev" title="Finding Help" href="finding-help.html" /> 
</head>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="_sources/reporting-bugs.rst.txt" rel="nofollow"> View page source</a>
...
<p>If you believe you have uncovered a bug in mod_wsgi code then lodge a bug
report on the mod_wsgi issue tracker. The issue tracker is located on
GitHub at:</p>
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/GrahamDumpleton/mod_wsgi/issues">https://github.com/GrahamDumpleton/mod_wsgi/issues</a></p></li>
</ul>
<p>Before creating a ticket on the issue tracker, please do try and ensure you
attempt to resolve issues using the mod_wsgi mailing list first as
explained in <a class="reference internal" href="finding-help.html"><span class="doc">Finding Help</span></a>. The majority of issues lodged via the
issue tracker are not actually bugs in mod_wsgi but due to external factors
or simply a failure to read the documentation.</p>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="finding-help.html" class="btn btn-neutral float-left" title="Finding Help" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
    </div>
