...
function check_distro {
    ...
    if ls /var/www/html/EL7-x86_64/Packages/centos-release-7-*.el7.centos.x86_64.rpm; then
        cobbler distro edit --name EL7-x86_64 --autoinstall-meta=tree=http://10.0.0.1/EL7-x86_64/
    fi
    if ls /var/www/html/EL7-aarch64/Packages/centos-release-7-*.el7.centos.a.aarch64.rpm; then
        cobbler distro edit --name EL7-aarch64-aarch64 --autoinstall-meta=tree=http://10.0.0.1/EL7-aarch64/
    fi
    if ls /var/www/html/FHOS-x86_64/Packages/FitStarrySkyOS-release-22.06.1-*.x86_64.rpm; then
        cobbler distro edit --name FHOS-x86_64 --autoinstall-meta=tree=http://10.0.0.1/FHOS-x86_64/
    fi
    if ls /var/www/html/FHOS-aarch64/Packages/FitStarrySkyOS-release-22.06.1-*.aarch64.rpm; then
        cobbler distro edit --name FHOS-aarch64-aarch64 --autoinstall-meta=tree=http://10.0.0.1/FHOS-aarch64/
    fi
}
